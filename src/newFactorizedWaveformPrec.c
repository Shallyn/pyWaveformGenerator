...
int EccPrec_CalcSpinPrecFacWaveformCoefficients(
    ...
    const REAL8 chiS, const REAL8 chiA, const REAL8 csx,         /**< (chi1+chi2)/2 */
    const REAL8 csy, const REAL8 csz, const REAL8 cax,           /**< (chi1-chi2)/2 */
    const REAL8 cay, const REAL8 caz, UINT SpinAlignedEOBversion /**< 1 for SEOBNRv1; 2 for SEOBNRv2; 4 for the
...
)
{
    ...
    coeffs->h22T4ff20 = -425. / 504. + 1355. * eta / 252. - 20. * eta2 / 63. + cax * I * (-3. / 2. - 19. * eta / 28.) +
                        cay * (-3. / 2. - 37. * eta / 42.) + csx * dM * I * (-3. / 2. - 9. * eta / 28.) +
                        csy * dM * (-3. / 2. - 11. * eta / 14.) +
                        0.5 * (pow(dM * cay + (1. - 2. * eta) * csy, 2.) + pow(dM * caz + (1. - 2. * eta) * csy, 2.));
    ...
    coeffs->h22T4ff11 = I * (-359. / 378. - 592. * eta / 189. - 307. * eta2 / 378.) +
                        cax * (-3. / 2. - 51. * eta / 28.) + cay * I * (5. / 2. - 5. * eta / 12.) +
                        csx * dM * (-3. / 2. + 125. * eta / 84.) + csy * I * dM * (5. / 2. + eta / 12.) +
                        (dM * cax + (1. - 2. * eta) * csx) * (dM * cay + (1. - 2. * eta) * csy);
    coeffs->h22T4ff06 = 1. / 42. + 179. * eta / 336. + 25. * eta2 / 48.;
    coeffs->h22T4ff04 = 317. / 1008. - 1045. * eta / 1008. - 101. * eta2 / 144.;
    coeffs->h22T4ff02 = -10379. / 3024. - 635. * eta / 189. + 26. * eta2 / 189. +
                        cax * I * (9. / 4. - 89. * eta / 14.) + cay * (3. / 4. + 71. * eta / 84.) +
                        csx * I * dM * (9. / 4. - 55. * eta / 42.) + csy * dM * (3. / 4. + 13. * eta / 84.) -
                        I * (dM * cax + (1. - 2. * eta) * csx) * (dM * cay + (1. - 2. * eta) * csy) +
                        0.5 * (pow(dM * cay + (1. - 2. * eta) * csy, 2.) + pow(dM * caz + (1. - 2. * eta) * csy, 2.));
    coeffs->h22T4ff00 = 65. / 252. - 31. * eta / 36. + 205. * eta2 / 252. + cax * I * (-1. + 19. * eta / 14.) +
                        cay * (-1. / 3. - 19. * eta / 21.) + csx * I * dM * (-1. + 9. * eta / 14.) +
                        csy * dM * (-1. / 3. + 5. * eta / 21.) -
                        2. * I * (dM * cax + (1. + eta) * csx) * (dM * cay + (1. + eta) * csy) + 6. * I * csx * csy +
                        0.5 * (pow(dM * cay + (1. + eta) * csy, 2.) + pow(dM * caz + (1. + eta) * csy, 2.) -
                               3. * eta2 * (csy * csy + csz * csz));
    ...
    if (dM2)
    {
        ...
        coeffs->h21T3ff00 = (6. - 95. * eta / 14.) * caz / dM + (6. - 59. * eta / 14.) * csz +
                            I * (9. - 36. * eta) * cax * caz / dM + 9. * I * (caz * csx + cax * csz) +
                            9. * I * csx * csz / dM;
    }
    else
    {
    ...
    coeffs->h44T2ff20 = (579. + eta * (-2290. + 783. * eta) + 132 * eta * (I * cax + cay - I * dM * (csx - I * csy))) /
                        1408. / m1Plus3eta;
    coeffs->h44T2ff15 = 9. * (-4. + eta * m2Plus35eta) / 176. / m1Plus3eta;
    coeffs->h44T2ff13 = -3. * (577. + 15. * eta * (-196 + 295 * eta)) / 3520. / m1Plus3eta;
    coeffs->h44T2ff11 =
        (1416. - 5. * eta * (536. + 465. * eta) - 825 * eta * (I * cax + cay - dM * I * (csx - I * csy))) / 1760. /
        m1Plus3eta;
    coeffs->h44T2ff06 = 9. * (-4. + eta * m2Plus35eta) / 704. / m1Plus3eta;
    coeffs->h44T2ff04 = 9. * (859. + 10. * eta * (-512. + 457. * eta)) / 14080. / m1Plus3eta;
    coeffs->h44T2ff02 =
        (53913. + 30. * eta * (-5746. + 1291. * eta) - 16180 * eta * (I * cax + cay - dM * (I * csx + csy))) / 14080. /
        m1Plus3eta;
    coeffs->h44T2ff00 =
        (397. + eta * (-1358. + 621. * eta) - 132 * eta * (I * cax + cay - dM * (I * csx + csy))) / 704. / m1Plus3eta;
...
INT CalculateFacWaveformAmpResV3(FacWaveformCoeffs *const hCoeffs, const REAL8 eta, const INT l, const INT m,
                                 ...
                                 const REAL8 x0, const REAL8 x1, const REAL8 x2, COMPLEX16 *facAmpRes)
{
    ...
    case 2:
        ...
        case 1:
            ...
            A2lm = g2 * (hCoeffs->h21T2ff21 * ff21 + hCoeffs->h21T2ff12 * I * ff12 + hCoeffs->h21T2ff03 * ff03 +
                         hCoeffs->h21T2ff01 * ff01);
    ...
    case 3:
        ...
        case 3:
            ...
            Flm3 = (hCoeffs->h33T3ff20 * ff20 + hCoeffs->h33T3ff11 * I * ff11 + hCoeffs->h33T3ff02 * ff02 +
 ...
 */
INT XLALSimIMRSpinEOBGetSpinFactorizedWaveformV3(COMPLEX16 *ret,
...
)
{
    ...
    if (CalculateFacWaveformAmpResV3(hCoeffs, eta, l, m, v, vPhi, vh3, eulerlogxabs, 1 / sqrt(r), dr, ncrv,
...
)
{
    ...
    for (l = 2; l <= lMax; l++)
    {
        for (m = 1; m <= l; m++)
        {
            if (XLALSimIMRSpinEOBGetSpinFactorizedWaveformV3(&hLM, values, v, dr, ncrv, H, l, m, ak, 1) != CEV_SUCCESS)
            {
...
/*                                                              */
/*--------------------------------------------------------------*/
INT XLALSimIMRSpinEOBFluxGetPrecSpinFactorizedWaveformV3(
 ...
 * https://dcc.ligo.org/T1400476
 */
INT XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV3(
...
INT XLALSimIMRSpinEOBGetAmplitudeResidualPrecV3(
    ...
    SpinEOBParams *params)
{
    ...
    if (CalculateFacWaveformAmpResV3(hCoeffs, eta, modeL, modeM, v, vPhi, vh3, eulerlogxabs, 1 / sqrt(r), dr, ncrv,
                                     &rholmPwrl) != CEV_SUCCESS)
        return CEV_FAILURE;
    *rholmpwrl = rholmPwrl;
    return CEV_SUCCESS;
...
REAL8
XLALInspiralPrecSpinFactorizedFluxV3(REAL8Vector *polvalues,          /**< \f$(r,\phi,p_r,p_\phi)\f$ */
