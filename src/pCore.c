...
#define GSL_END gsl_set_error_handler(saveGSLErrorHandler_);
 ...
 */
REAL8
FindClosestValueInIncreasingVector(REAL8Vector *vec, /**<< Input: monotonically increasing vector */
...
REAL8
SEOBCalculatetplspin(REAL8 m1, REAL8 m2, REAL8 eta, REAL8 chi1dotZ, REAL8 chi2dotZ)
{
...
static INT XLALEOBSpinPrecCalcSEOBHCoeffConstants(REAL8 eta, SEOBHCoeffConstants *ret)
{
    ...
    REAL8 kC4 = 0. + 31.333333333333332 * tmp10 - 1.28125 * tmp10 * tmp28 + tmp32 + 8. * tmp18 * tmp34 +
                0.6666666666666666 * tmp36 * tmp37 - 4. * tmp4 + 24. * tmp19 * tmp6 - 4. * coeffsKK * tmp7;
    REAL8 kC5 = -12. * coeffsKK * tmp16 + 2. * tmp18 * tmp19 + tmp23 - 2. * tmp18 * tmp34 + 8. * tmp16 * tmp6 -
                12. * tmp19 * tmp6;
    REAL8 kC6 = 1. * coeffsKK * tmp16 - tmp16 * tmp6 + 0.5 * tmp19 * tmp6 - coeffsKK * tmp7 + 0.5 * tmp6 * tmp7;
    REAL8 kC7 = -35.12753102199746 * tmp10 + 25.6 * CST_GAMMA * tmp10 - 32. * coeffsKK * tmp19 +
                4.443359375 * tmp10 * tmp28 + tmp32 - 32. * tmp18 * tmp37 - 62.666666666666664 * tmp4 +
                2.5625 * tmp28 * tmp4 + 4. * tmp19 * tmp6 - 64. * tmp34 * tmp6 - 5.333333333333334 * tmp36 * tmp64 +
                8. * tmp7 - 62.666666666666664 * coeffsKK * tmp7 + 2.5625 * coeffsKK * tmp28 * tmp7 -
                0.2666666666666661 * pow(coeffsKK, 5.) * pow(m1PlusEtaKK, 10.);
    REAL8 kC8 = -10. * coeffsKK * tmp16 + 32. * coeffsKK * tmp19 - 12. * tmp18 * tmp34 + 16. * tmp18 * tmp37 -
                1.3333333333333337 * tmp36 * tmp37 - 24. * tmp19 * tmp6 + 48. * tmp34 * tmp6 +
                1.3333333333333337 * tmp36 * tmp64 - 2. * tmp7 + 2. * coeffsKK * tmp7;
    REAL8 kC9 = 4. * coeffsKK * tmp16 - 6. * coeffsKK * tmp19 - tmp18 * tmp19 + 2. * tmp18 * tmp34 - tmp18 * tmp37 -
                2. * tmp16 * tmp6 + 8. * tmp19 * tmp6 - 6. * tmp34 * tmp6;
    ret->a0k2 = kC0;
    ret->a1k2 = kC1;
    ret->a0k3 = kC2;
    ret->a1k3 = kC3;
...
{
    return ((im * imDDot + pow(imDot, 2)) * pow(re, 2) + pow(re, 3) * reDDot +
            im * re * (im * reDDot - 2 * imDot * reDot) + pow(im, 2) * (im * imDDot + pow(reDot, 2))) /
           pow(pow(im, 2) + pow(re, 2), 1.5);
}
...
{
    return ((pow(im, 2) + pow(re, 2)) * (imDDot * re - im * reDDot) -
            2 * (imDot * re - im * reDot) * (im * imDot + re * reDot)) /
           pow(pow(im, 2) + pow(re, 2), 2);
}
typedef struct tagCalPNCoeffsRootParams
{
    REAL8 eAmp;
    REAL8 eAmpDot;
    REAL8 eAmpDDot;
...
static int gslfuncFindCalPNCoeffs(const gsl_vector *x, void *params, gsl_vector *f)
{
    ...
    combDot = 2 * k4 * x0 * x0Dot + I * k1 * x0Dot * x1 + I * k1 * x0 * x1Dot + k3 * x0Dot * x2 + I * k2 * x1Dot * x2 +
              k3 * x0 * x2Dot + I * k2 * x1 * x2Dot + 2 * k5 * x2 * x2Dot;
    combDDot = 2 * k4 * x0 * x0DDot + 2 * k4 * pow(x0Dot, 2) + I * k1 * x0DDot * x1 + I * k1 * x0 * x1DDot +
               I * k1 * x0Dot * x1Dot + k3 * x0DDot * x2 + I * k2 * x1DDot * x2 + k3 * x0 * x2DDot +
               I * k2 * x1 * x2DDot + 2 * k5 * x2 * x2DDot + 2 * k3 * x0Dot * x2Dot + I * k2 * x1Dot * x2Dot +
               2 * k5 * pow(x2Dot, 2);
    ...
    eobAmpDDot = eAmp * CalPN_calculateAmpDDot(Rtot, Itot, RtotDot, ItotDot, RtotDDot, ItotDDot) +
                 2 * eAmpDot * CalPN_calculateAmpDot(Rtot, Itot, RtotDot, ItotDot) +
                 eAmpDDot * sqrt(Rtot * Rtot + Itot * Itot);
    // print_debug("IN: nra = %f, ea = %f, eoba = %f\n", nrAmp, eAmp, eobAmp);
    // print_debug("IN: nrOmega = %f, eO = %f, eobOmega = %f\n", nrOmega, eOmega,
    // eobOmega); print_debug("IN: nrAmpDot = %f, eAD = %f, eobAmpDot = %f\n",
    // nrAmpDot, eAmpDot, eobAmpDot); print_debug("IN: nrOmegaDot = %f, eOD = %f,
    // eobOmegaDot = %f\n\n", nrOmegaDot, eOmegaDot, eobOmegaDot);
    // print_debug("IN: nrAmpDDot = %f, eADD = %f, eobAmpDDot = %f\n", nrAmpDDot,
    // eAmpDDot, eobAmpDDot); print_debug("RST: x = %f + i%f\n", yr, yi);
...
static INT FindCalPNCoeffs(COMPLEX16 hLM, COMPLEX16 hLMDot, COMPLEX16 hLMDDot, COMPLEX16 rholm, COMPLEX16 rholmDot,
                           COMPLEX16 rholmDDot, REAL8 nrAmp, REAL8 nrAmpDot, REAL8 nrAmpDDot, REAL8 nrOmega,
                           REAL8 nrOmegaDot, REAL8 x0, REAL8 dx0dt, REAL8 dx0dt2, REAL8 x1, REAL8 dx1dt, REAL8 dx1dt2,
                           REAL8 x2, REAL8 dx2dt, REAL8 dx2dt2, INT order, REAL8 initval, REAL8 *out1, REAL8 *out2,
                           REAL8 *out3, REAL8 *out4, REAL8 *out5)
{
    int i = 0, gslStatus;
    ...
    rootParams.eAmpDDot =
        CalPN_calculateAmpDDot(creal(hLM), cimag(hLM), creal(hLMDot), cimag(hLMDot), creal(hLMDDot), cimag(hLMDDot));
    rootParams.eOmega = eOmega;
    rootParams.eOmegaDot =
        CalPN_calculateOmegaDot(creal(hLM), cimag(hLM), creal(hLMDot), cimag(hLMDot), creal(hLMDDot), cimag(hLMDDot));

    rootParams.rholm = rholm;
    rootParams.rholmDot = rholmDot;
    rootParams.rholmDDot = rholmDDot;
    REAL8 tgtAmp, tgtAmpDot, tgtOmega;
    tgtAmp = eAmp + ((nrAmp - eAmp > 0) ? 1. : -1) *
                        (fabs(nrAmp - eAmp) * 0.1 < eAmp * 0.01 ? fabs(nrAmp - eAmp) * 0.1 : eAmp * 0.01);
    tgtAmpDot = eAmpDot + ((nrAmpDot - eAmpDot > 0) ? 1. : -1) * (fabs(nrAmpDot - eAmpDot) * 0.5 < fabs(eAmpDot) * 0.1
                                                                      ? fabs(nrAmpDot - eAmpDot) * 0.5
                                                                      : fabs(eAmpDot) * 0.1);
    tgtOmega = eOmega + ((nrOmega - eOmega > 0) ? 1. : -1.) * (fabs(nrOmega - eOmega) * 0.2 < fabs(eOmega) * 0.1
                                                                   ? fabs(nrOmega - eOmega) * 0.2
                                                                   : fabs(eOmega) * 0.1);
    ...
    *out4 = rst4;
    *out5 = rst5;
    // print_debug("FINAL: nra = %f, fiteobAmp = %f, nraDot = %f, fiteobAmpDot =
...
)
{
    ...
    REAL8 rAttachmentPoint, hLMdivrholmEAttachmentPoint, rholmENRAttachmentPoint, rholmERealBeforeCalAP,
        rholmEImagBeforeCalAP;
    REAL8 v;
    ...
    if (!hLMVec || !rholmpwrlVec || !timeVec || !rholmpwrlVec || !rholmpwrlVecReal || !hLMdivrholmEVec ||
        !rholmpwrlEVecReal)
    {
        failed = 1;
        goto QUIT;
    ...
    /* The calibration parameter is only used for 21 and 55 modes, if you try to
     * use this function for other modes, you get an error */
    ...
    REAL8 timewavePeak = timeorb - XLALSimIMREOBGetNRSpinPeakDeltaTv4(modeL, modeM, m1, m2, spin1z_omegaPeak,
                                                                      spin2z_omegaPeak, params->hParams);
    ...
    // timeVec->data[orbOmegaVec.length-1]);
    ...
    for (i = 0; i < orbOmegaVec.length; i++)
    {
        ...
        if (CODE_VERSION == 3)
        {
            if (EccPrec_CalcSpinPrecFacWaveformCoefficients(
                    params->hCoeffs, m1, m2, eta, tplspin, chiS, chiA, seobdynamics->chiSxVec[i],
                    seobdynamics->chiSyVec[i], seobdynamics->chiSzVec[i], seobdynamics->chiAxVec[i],
                    seobdynamics->chiAyVec[i], seobdynamics->chiAzVec[i], 451) == CEV_FAILURE)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in EccPrec_CalcSpinPrecFacWaveformCoefficients "
                               "at step %d of the loop.",
                               i);
                return CEV_FAILURE;
            }
        }
        ...
        {
            if (XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients(params->hCoeffs, m1, m2, eta, tplspin, chiS, chiA,
                                                                 SEOBWaveformVersion) == CEV_FAILURE)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in "
                               "XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients at "
                               "step %d of the loop.",
                               i);
                failed = 1;
                goto QUIT;
        ...
        // if (CODE_VERSION == 0)
        // {
        if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform(&(hLMVec->data[i]), &polarDynamics, &values, v,
                                                           HamVec.data[i], modeL, modeM, params) == CEV_FAILURE)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform at "
                           "step "
                           "%d of the loop.",
                           i);
            failed = 1;
        ...
        if (XLALSimIMRSpinEOBGetAmplitudeResidualPrec(&(rholmpwrlVec->data[i]), v, HamVec.data[i], modeL, modeM,
                                                      params) == CEV_FAILURE)
        // RC: for the 21 and 55 mode rholmpwrlVec is always real. This is not
        // true for the 33 mode. For this reason, in order to make this
        // function general, we use a complex variable for it.
        {
            /* TODO: Clean-up */
            failed = 1;
            goto QUIT;
        ...
        // {
        dr =
            (seobdynamics->posVecx[i] * seobdynamics->velVecx[i] + seobdynamics->posVecy[i] * seobdynamics->velVecy[i] +
             seobdynamics->posVecz[i] * seobdynamics->velVecz[i]) /
            seobdynamics->polarrVec[i];
        ncrv = seobdynamics->polarrVec[i] * orbOmegaVec.data[i];
        drVec->data[i] = dr;
        ncrvVec->data[i] = ncrv;
        if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2(&hLME, &polarDynamics, &values, v, dr, ncrv,
                                                             seobdynamics->polarprDotVec[i], HamVec.data[i], modeL,
                                                             modeM, params) == CEV_FAILURE)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2 at "
                           "step "
                           "%d of the loop.",
                           i);
            failed = 1;
        ...
        //     seobdynamics->chiSxVec[i], seobdynamics->chiSyVec[i],
        //     seobdynamics->chiSzVec[i],
        //             seobdynamics->chiAxVec[i], seobdynamics->chiAyVec[i],
        //             seobdynamics->chiAzVec[i]);
        // }

        if (XLALSimIMRSpinEOBGetAmplitudeResidualPrecV2(&rholmpwrlE, &polarDynamics, &values, v, dr, ncrv,
                                                        HamVec.data[i], modeL, modeM, params) == CEV_FAILURE)
        // RC: for the 21 and 55 mode rholmpwrlVec is always real. This is not
        // true for the 33 mode. For this reason, in order to make this
        // function general, we use a complex variable for it.
        ...
        // print_debug("[%d]rholmPwrlReal = %.3e + i%.3e, v = %g, dr = %g, ncrv =
        // %g \n",
        //     i, creal(rholmpwrlVec->data[i]), cimag(rholmpwrlVec->data[i]), v,
        //     dr, ncrv);
        // if (timeVec->data[i] > 0.9*timewavePeak)
        //     print_debug("t[%d] = %g, rholmpwrlEVec = %.3e + i%.3e\n",
        //             i, timeVec->data[i], rholmpwrlEVecReal->data[i],
        //             rholmpwrlEVecImag->data[i]);
        // print_debug("t[%d] = %g, rholmpwrlEVec = %.3e + i%.3e, hLM = %.3e +
        // i%.3e,r = %g, v = %g, dr = %g, ncrv = %g, ham = %g \n",
        //     i, timeVec->data[i], rholmpwrlEVecReal->data[i],
        //     rholmpwrlEVecImag->data[i], creal(hLME), cimag(hLME),
        //     seobdynamics->polarrVec[i], v, dr, ncrv, HamVec.data[i]);
    }
    ...
    nrOmega = XLALSimIMREOBGetNRSpinPeakOmegaV4(
        modeL, modeM, eta, chiS_omegaPeak + chiA_omegaPeak * (m1 - m2) / (m1 + m2) / (1. - 2. * eta));
    nrOmegaDot = XLALSimIMREOBGetNRSpinPeakOmegaDotV4(
        modeL, modeM, eta, chiS_omegaPeak + chiA_omegaPeak * (m1 - m2) / (m1 + m2) / (1. - 2. * eta));
    ...
    // x1APDDot); print_debug("x2 = %f, x2Dot = %f, x2DDot = %f\n", x2AP,
    // x2APDot, x2APDDot);
    ...
    if ((modeL == 2) && (modeM == 1))
    {
        /* Here we compute ((rho_lm^l + f_lm + CalPar*omega^7/3)_NR - (rho_lm^l +
        f_lm)_EOB)/omega^7/3 to get CalPar. The factor
        rholmpwrlVecReal->data[0])/cabs(rholmpwrlVecReal->data[0]) is used to
        know the sign of the function (rho_lm^l + f_lm + CalPar*omega^7/3)_NR
        which is computed as absolute value */
        params->cal21 =
            (rholmNRAttachmentPoint - rholmBeforeCalibAttachmentPoint) / (pow(omegaAttachmentPoint, 7. / 3.));
        initval = (rholmENRAttachmentPoint - rholmEBeforeCalAP) * (pow(rAttachmentPoint, 12. / 2.));
        // initval = (rholmENRAttachmentPoint - rholmEBeforeCalAP)
        // /(pow(omegaAttachmentPoint,7./3.)); retval = FindCalPNCoeffs(hLMPeak,
        // hLMPeakDot, hLMPeakDDot,
        ...
        //             5, creal(initval), &PNCalCoeff1, &PNCalCoeff2,
        //             &PNCalCoeff3, &PNCalCoeff4, &PNCalCoeff5);
        params->cal21E = creal(initval);
        // if (retval != CEV_SUCCESS)
        //     params->cal21E = creal(initval);
        // else
        // {
        // params->cal21E1 = PNCalCoeff1;// * rholmEBeforeCalAP / (hLMrealAP +
        // I*hLMimagAP); params->cal21E2 = PNCalCoeff2;// * rholmEBeforeCalAP /
        // (hLMrealAP + I*hLMimagAP); params->cal21E3 = PNCalCoeff3;
        // params->cal21E = PNCalCoeff4; params->cal21E4 = PNCalCoeff5;
        // print_debug("fitpms = %f, %f, %f, %f, %f, %f\n", PNCalCoeff1,
        // PNCalCoeff2, PNCalCoeff3, PNCalCoeff4, PNCalCoeff5,
        // params->hCoeffs->f21v6);
        // }
        // Test
        // COMPLEX16 fithLMPeak, fithLMDotPeak;
        // REAL8 fitALMDotPeak;
        // REAL8 Re, Im, ReDot, ImDot;
        // fithLMPeak = hLMPeak * (rholmEBeforeCalAP + pow(x0AP, 7) *
        // params->cal21E); fithLMPeak = hLMPeak + pow(x0AP, 7)*PNCalCoeff1 +
        // pow(x0AP, 8) * PNCalCoeff2; fithLMDotPeak = hLMrealAPDot +
        // I*hLMimagAPDot
        // + 7*pow(x0AP, 6)*x0DotAP*PNCalCoeff1 + 8*pow(x0AP, 7)*x0DotAP *
        // PNCalCoeff2; fitALMDotPeak = (cimag(fithLMPeak) * cimag(fithLMDotPeak)
        // + creal(fithLMPeak) * creal(fithLMDotPeak)) / cabs(fithLMPeak);

        // print_debug("nra = %f, eoba = %f, nraDot = %f, eobaDot = %f\n", nra,
        // cabs(fithLMPeak), nraDot, fitALMDotPeak); print_debug("cal21 = %.16f,
        // nra = %.3f\n", params->cal21, nra);
    }
    if ((modeL == 5) && (modeM == 5))
    {
        ...
        which is computed as absolute value */
        params->cal55 =
            (rholmNRAttachmentPoint - rholmBeforeCalibAttachmentPoint) / (pow(omegaAttachmentPoint, 5. / 3.));
        // printf("params->cal55 = %.16f\n",params->cal55);
    }
    // if (isnan(params->cal21) || isnan(params->cal21E1) ||
    // isnan(params->cal21E2) || isnan(params->cal21E) || isnan(params->cal55))
    if (isnan(creal(params->cal21)) || isnan(cimag(params->cal21)) || isnan(params->cal21E1) ||
        isnan(params->cal21E2) || isnan(params->cal21E) || isnan(creal(params->cal55)) || isnan(cimag(params->cal55)))
    {
        ...
        PRINT_LOG_INFO(LOG_DEBUG, "cal21 = %g + i %g, cal21E = %g, rAttachmentPoint = %g\n", creal(params->cal21),
                       cimag(params->cal21), params->cal21E, rAttachmentPoint);
        PRINT_LOG_INFO(LOG_DEBUG,
                       "rholmNRAttachmentPoint = %g, rholmBeforeCalibAttachmentPoint = %g, "
                       "omegaAttachmentPoint = %g",
...
)
{
    ...
    {
        PRINT_LOG_INFO(LOG_CRITICAL,
                       "failure in XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients at "
                       "step "
                       "%d of the loop.",
                       i);
        failed = 1;
    ...
    for (i = 0; i < orbOmegaVec.length; i++)
    {
        ...
        //     timeVec->data[i], seobdynamics->rVec[i], seobdynamics->phiVec[i],
        ...
        // {
        // DEBUG_START;
        if (XLALSimIMRSpinEOBGetSASpinFactorizedWaveform(&(hLMVec->data[i]), &polarDynamics, v, HamVec.data[i], modeL,
                                                         modeM, params) == CEV_FAILURE)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform at "
        ...
        drVec->data[i] = dr;
        ncrvVec->data[i] = ncrv;
        if (XLALSimIMRSpinEOBGetSASpinFactorizedWaveformV2(&hLME, &polarDynamics, v, dr, ncrv, 0, HamVec.data[i], modeL,
                                                           modeM, params) == CEV_FAILURE)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2 at "
        ...
        if (XLALSimIMRSpinEOBSAGetAmplitudeResidualPrecV2(&rholmpwrlE, &polarDynamics, v, dr, ncrv, HamVec.data[i],
                                                          modeL, modeM, params) == CEV_FAILURE)
        // RC: for the 21 and 55 mode rholmpwrlVec is always real. This is not
        // true for the 33 mode. For this reason, in order to make this
        // function general, we use a complex variable for it.
        {
        ...
        // print_debug("[%d]");
        // if (rholmpwrlVecReal->data[i] == 0.0)
        //     print_debug("[%d]rholmPwrlReal = %.3e + i%.3e, v = %g, dr = %g,
        //     ncrv = %g \n",
        //         i, creal(rholmpwrlVec->data[i]), cimag(rholmpwrlVec->data[i]),
        //         v, dr, ncrv);
        // if (timeVec->data[i] > 0.9*timewavePeak)
        //     print_debug("t[%d] = %g, rholmpwrlEVec = %.3e + i%.3e\n",
        //             i, timeVec->data[i], rholmpwrlEVecReal->data[i],
...
// XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients in the loop will be
// repeated across modes -- would be more efficient to loop on modes inside the
// loop on times
static int SEOBCalculatehlmAmpPhase(CAmpPhaseSequence **hlm,    /**<< Output: hlm in complex amplitude / phase form */
...
)
{
    ...
    if (includeNQC == 0 && seobParams->hParams->Mf_max < seobParams->hParams->Mf_min && seobParams->hParams->tM_max < 0)
    {
        if (((l == 2) && (m == 1)) || ((l == 5) && (m == 5)))
        {
            if (XLALSimIMREOBCalcCalibCoefficientHigherModesPrec(
                    seobParams, l, m, seobdynamics, tPeakOmega - seobdynamics->tVec[0], m1, m2, deltaT) == CEV_FAILURE)
            {
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        {
            if (EccPrec_CalcSpinPrecFacWaveformCoefficients(
                    seobParams->hCoeffs, m1, m2, eta, tplspin, chiS, chiA, seobdynamics->chiSxVec[i],
                    seobdynamics->chiSyVec[i], seobdynamics->chiSzVec[i], seobdynamics->chiAxVec[i],
                    seobdynamics->chiAyVec[i], seobdynamics->chiAzVec[i], 451) == CEV_FAILURE)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
        ...
        {
            if (XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients(seobParams->hCoeffs, m1, m2, eta, tplspin, chiS, chiA,
        ...
        if (CODE_VERSION == 0)
        {
            if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform(&hlm_val, &polarDynamics, &values, v, ham, l, m,
                                                               seobParams) != CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform "
                               "at step "
                               "%d of the loop.",
                               i);
                return CEV_FAILURE;
        ...
        else
        {
            ...
            if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2(&hlm_val, &polarDynamics, &values, v, dr, ncrv,
                                                                 seobdynamics->polarprDotVec[i], ham, l, m,
                                                                 seobParams) != CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in "
                               "XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2 at "
                               "step %d of the loop.",
                               i);
                return CEV_FAILURE;
            }
        ...
        if (includeNQC)
        {
            if (XLALSimIMRSpinEOBNonQCCorrection(&factor_nqc, &values, omega, t, seobParams->tWind, seobParams->wWind,
                                                 nqcCoeffs) == CEV_FAILURE)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in XLALSimIMRSpinEOBNonQCCorrection at step %d "
                               "of the loop.",
                               i);
                return CEV_FAILURE;
            }
...
static int SEOBSACalculatehlmAmpPhase(CAmpPhaseSequence **hlm, /**<< Output: hlm in complex amplitude / phase form */
                                      INT4 l,                  /**<< Input: mode index l */
                                      INT4 m,                  /**<< Input: mode index m */
...
)
{
    ...
    if (includeNQC == 0 && seobParams->hParams->Mf_max < seobParams->hParams->Mf_min && seobParams->hParams->tM_max < 0)
    {
        if (((l == 2) && (m == 1)) || ((l == 5) && (m == 5)))
        {
            ...
            {
                PRINT_LOG_INFO(LOG_CRITICAL, "failure in "
                                             "XLALSimIMREOBSACalcCalibCoefficientHigherModes.");
                return CEV_FAILURE;
            }
        }
    }
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        if (CODE_VERSION == 0)
        {
            if (XLALSimIMRSpinEOBGetSASpinFactorizedWaveform(&hlm_val, &polarDynamics, v, ham, l, m, seobParams) !=
                CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform "
        ...
        else
        {
            ...
            if (XLALSimIMRSpinEOBGetSASpinFactorizedWaveformV2(&hlm_val, &polarDynamics, v, dr, ncrv, 0, ham, l, m,
                                                               seobParams) != CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in "
        ...
        if (includeNQC)
        {
            if (XLALSimIMRSpinEOBSANonQCCorrection(&factor_nqc, &polarDynamics, omega, t, seobParams->tWind,
                                                   seobParams->wWind, nqcCoeffs) == CEV_FAILURE)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in XLALSimIMRSpinEOBNonQCCorrection at step %d "
                               "of the loop.",
        ...
        //         creal(hlm_val), cimag(hlm_val), creal(factor_nqc),
        //         cimag(factor_nqc));
        //     print_debug("t = %.16e, omega = %.16e, ham = %.16e, r = %.16e, phi
        //     =
        //     %.16e, prT = %.16e, pphi = %.16e\n\n",
        //         t, omega, ham, seobdynamics->rVec[i], seobdynamics->phiVec[i],
        //         seobdynamics->prTVec[i], seobdynamics->pphiVec[i]);
        // }
        // if (i==0 || i==1)
        // {
        //     print_debug("[%d,%d]%.16e\t%.16e\t%.16e\n", l, m, t,
        //     creal(hlmNQC), cimag(hlmNQC));
        //     // print_debug("t = %.16e, omega = %.16e, ham = %.16e, r = %.16e,
        //     phi = %.16e, prT = %.16e, pphi = %.16e\n",
        //     //     t, omega, ham, seobdynamics->rVec[i],
        //     seobdynamics->phiVec[i], seobdynamics->prTVec[i],
        //     seobdynamics->pphiVec[i]);
        // }
        // if (IS_DEBUG)
        //     print_out("%.16e\t%.16e\t%.16e\n", t, creal(hlmNQC),
        //     cimag(hlmNQC));
...
static int SEOBCalculatehlmAmpPhase_noNQC(
    CAmpPhaseSequence **hlm,    /**<< Output: hlm in complex amplitude / phase form */
    INT4 l,                     /**<< Input: mode index l */
    INT4 m,                     /**<< Input: mode index m */
    SEOBdynamics *seobdynamics, /**<< Input: SEOB dynamics */
    SpinEOBParams *seobParams   /**<< SEOB params */
 ...
 * phi, pr, pphi Generic-spin dynamics format: t, x, y, z, px, py, pz, s1x,
 * s1y, s1z, s2x, s2y, s2z, phiMod, phiDMod
 */
    ...
    *dynamics = CreateREAL8Array(2, 15, retLen);
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        (*dynamics)->data[4 * retLen + i] =
            prVec.data[i] * cos(phiVec.data[i]) - pPhiVec.data[i] / rVec.data[i] * sin(phiVec.data[i]);
        (*dynamics)->data[5 * retLen + i] =
            prVec.data[i] * sin(phiVec.data[i]) + pPhiVec.data[i] / rVec.data[i] * cos(phiVec.data[i]);
 ...
 * evolution.
 */
static int XLALEOBSpinPrecAlignedStopCondition(double t,              /**< UNUSED */
...
static int XLALEOBSpinPrecAlignedStopCondition_withFMax(
    double t,              /**< UNUSED */
    const double values[], /**< dynamical variable values */
    double dvalues[],      /**< dynamical variable time derivative values */
    void *funcParams       /**< physical parameters */
...
static int EOBHighSRStopConditionEcc(double t, const double values[], double dvalues[], void *funcParams)
{
    REAL8 r = values[0];
    SpinEOBParams *params = (SpinEOBParams *)funcParams;
    if (r > g_h_rISCO)
    ...
    pVec.data = pVal;
    omega = dvalues[1];
    ham = EOBHamiltonian(eta, &xVec, &pVec, params->s1Vec, params->s2Vec, params->sigmaKerr, params->sigmaStar,
    ...
    if (isnan(ham) || isnan(dvalues[3]) || isnan(dvalues[2]) || isnan(dvalues[1]) || isnan(dvalues[0]) ||
        (dvalues[2] >= 0. && dvalues[0] >= 0.) || params->omegaPeaked >= 5)
    {
        ...
        //     print_debug("The integration stopped because of dr&ddr > 0
        //     (%f)\n", r);
        // else
        //     print_debug("The integration stopped because of omegaPeaked > 5
        //     (%f)\n", r);
        // print_log("ham = %e, dvalues = (%e, %e, %e, %e)\n", ham, dvalues[0],
        // dvalues[1], dvalues[2], dvalues[3]);
        return 1;
    }
    params->omega = omega;
    return GSL_SUCCESS;
...
static int EOBHighSRStopConditionEcc_withFMax(double t, const double values[], double dvalues[], void *funcParams)
{
    REAL8 r = values[0];
    SpinEOBParams *params = (SpinEOBParams *)funcParams;
    if (r > g_h_rISCO)
 ...
 */
static int XLALSpinPrecAlignedHiSRStopCondition(double t,              /**< UNUSED */
                                                const double values[], /**< dynamical variable values */
                                                double dvalues[],      /**< dynamical variable time derivative values */
                                                void *funcParams       /**< physical parameters */
)
{
    ...
    if (dvalues[2] >= 0. || params->omegaPeaked == 5 || isnan(dvalues[3]) || isnan(dvalues[2]) || isnan(dvalues[1]) ||
        isnan(dvalues[0]))
    {
        return 1;
    }
...
static int XLALSpinPrecAlignedHiSRStopCondition_withFMax(
    double t,              /**< UNUSED */
    const double values[], /**< dynamical variable values */
    double dvalues[],      /**< dynamical variable time derivative values */
    void *funcParams       /**< physical parameters */
...
static int XLALSpinPrecAlignedHiSRStopCondition_inverse(
    double t,              /**< UNUSED */
    const double values[], /**< dynamical variable values */
    double dvalues[],      /**< dynamical variable time derivative values */
    void *funcParams       /**< physical parameters */
 ...
 */
static int XLALEOBSpinPrecStopConditionBasedOnPR(double t, const double values[], double dvalues[], void *funcParams)
{
    int debugPK = 0;
    ...
    // if (debugPK) {
    //     XLAL_PRINT_INFO(
    //         "XLALEOBSpinPrecStopConditionBasedOnPR:: values = %e %e %e %e %e
    //         %e\n", values[6], values[7], values[8], values[9], values[10],
    //         values[11]);
    // }
    // if (debugPK) {
    //     XLAL_PRINT_INFO(
    //         "XLALEOBSpinPrecStopConditionBasedOnPR:: dvalues = %e %e %e %e %e
    //         %e\n", dvalues[6], dvalues[7], dvalues[8], dvalues[9],
    //         dvalues[10], dvalues[11]);
    // }
    REAL8 rdot;
    ...
    double prDot = -inner_product3d(p, r) * rdot / r2 + inner_product3d(pdotVec, r) / sqrt(r2) +
    ...
    /* Table of termination conditions
        ...
        3                    r < 8 and |p_vec| > 10 (the momentum vector is
       large) 4                    r < 8 and |p_vec| < 1e-10 (momentum vector is
       small) 5                    r < 2 and omega has a another peak 6 r < 8 and
       omega < 0.04 or (r < 2. and  omega < 0.14 and omega has a peak) 7 r < 8
       and omega > 1 (unphysical omega) 8                    r < 5 and any of
       |dp_i/dt| > 10 9 r < 8 and pphi > 10 10                   r < 3 and rdot
       increases
    */
    ...
    if (r2 < 16 && pDotr >= 0)
    {
        // if (debugPK) {
        // XLAL_PRINT_INFO(
        //     "\n Integration stopping, p_r pointing outwards --
        //     out-spiraling!\n");
        // fflush(NULL);
        // }
    ...
    /* Terminate if dp_R/dt > 0, i.e. radial momentum is increasing for
     * separation <2M */
    if (r2 < 4. && prDot > 0.)
    {
        // if (debugPK) {
    ...
    if (r2 < 4. && params->omegaPeaked == 1 && omega > params->omega)
    {
        // if (debugPK) {
        // XLAL_PRINT_INFO(
     ...
     * r<2, break */
    if ((r2 < 16. && omega < 0.04) || (r2 < 4. && omega < 0.14 && params->omegaPeaked == 1))
    {
        // if (debugPK) {
...
static int XLALEOBSpinPrecStopConditionBasedOnPR_withFMax(double t, const double values[], double dvalues[],
                                                          void *funcParams)
{
    int debugPK = 0;
    int debugPKverbose = 0;
...
static int XLALEOBSpinPrecStopConditionBasedOnPR_inverse(double t, const double values[], double dvalues[],
                                                         void *funcParams)
{
    int debugPK = 0;
    int debugPKverbose = 0;
                                   ...
                                   REAL8 e0, HyperParams *params)
{
    ...
    {
        PRINT_LOG_INFO(LOG_CRITICAL,
                       "Somehow the mass ratio eta = %.16e > 0.25 (q = %.16e), which "
                       "implies "
                       "that double precision floating-point numbers are not enough.",
                       eta, q);
        eta = 0.25;
    }
    chi1Vec->data[0] = s1x;
    ...
    if (a > 1e-6)
    {
        ...
        S_con /= (1 - 2 * eta);
        S_con += (inner_product3d(S1_perp, sigmaKerr->data) + inner_product3d(S2_perp, sigmaKerr->data)) / a /
                 (1 - 2 * eta) / 2.;
    }
    ...
    if (XLALSimIMREOBComputeNewtonMultipolePrefixes(prefixes, m1, m2) != CEV_SUCCESS)
        goto QUIT;
    CalculateEccCorrectionCoeffs(eta, s1z, s2z,
                                 eccCoeffs); // only used in SA code... 2022.9.14
...
INT SEOBInitialConditions(REAL8Vector *ICvalues, REAL8 MfMin, REAL8 ecc, SpinEOBParams *seobParams)
{
    ...
    //         memcpy( ICvalues->data+6, seobParams->s1Vec->data,
    //         sizeof(mSpin1data) ); memcpy( ICvalues->data+9,
    //         seobParams->s2Vec->data, sizeof(mSpin1data) ); return CEV_SUCCESS;
    //     }
    // }
    ...
    if (seobParams->alignedSpins)
    {
        ...
        if (XLALSimIMREOBCalcSpinFacWaveformCoefficients(seobParams->hCoeffs, seobParams, tplspin, chiS, chiA) !=
            CEV_SUCCESS)
            return CEV_FAILURE;
        ...
        // mSpin1data[1], mSpin1data[2]); print_debug("mSpin2data = (%g, %g,
...
INT SEOBInitialConditions_Conserve(REAL8Vector *ICvalues, REAL8 MfMin, REAL8 ecc, SpinEOBParams *seobParams)
{
    ...
    if (tcons < 0)
    {
        if (seobParams->alignedSpins)
        {
            ...
            // print_debug("mSpin1data = (%g, %g, %g)\n", mSpin1data[0],
            // mSpin1data[1], mSpin1data[2]); print_debug("mSpin2data = (%g, %g,
            // %g)\n", mSpin2data[0], mSpin2data[1], mSpin2data[2]); if
            // (EOBInitialConditions(ICvalues, m1, m2, fMin, ecc, 0, mSpin1data,
            // mSpin2data, seobParams) != CEV_SUCCESS)
            //     return CEV_FAILURE;
            if (EOBInitialConditionsPrec(ICvalues, m1, m2, fMin, ecc, 0, mSpin1data, mSpin2data, seobParams) !=
                CEV_SUCCESS)
                return CEV_FAILURE;
        }
        else
    ...
    else
    {
        if (seobParams->alignedSpins)
        {
            ...
            if (seobParams->p0 > 0)
            {
                if (EOBInitialConditionsPrec_epi(ICvalues, m1, m2, seobParams->p0, ecc, seobParams->x0, mSpin1data,
                                                 mSpin2data, seobParams) != CEV_SUCCESS)
                    return CEV_FAILURE;
            }
            else if (EOBInitialConditionsPrec_Conserve(ICvalues, m1, m2, fMin, ecc, 0, mSpin1data, mSpin2data,
                                                       seobParams) != CEV_SUCCESS)
                return CEV_FAILURE;
        }
        else
...
int XLALEOBCheckNyquistFrequency(REAL8 m1, REAL8 m2, REAL8 spin1[3], REAL8 spin2[3], REAL8 deltaT, UINT ell_max)
{
    ...
    if (XLALSimIMREOBGenerateQNMFreqV2Prec(&modefreqVec, m1, m2, spin1, spin2, mode_highest_freqL, mode_highest_freqM,
                                           1) == CEV_FAILURE)
    {
        return CEV_FAILURE;
    }
...
void SortSEOBDynamicsArray_aligned(REAL8Array **ret_dyn, INT length, REAL8Array *dyn_inv)
{
    INT i, j;
    ...
    for (i = 0; i < length; i++)
    {
        ...
        //     dyn_inv->data[i], dyn_inv->data[i + length], dyn_inv->data[i +
        //     2*length], dyn_inv->data[i + 3*length], dyn_inv->data[i +
        //     4*length]);
...
void SortSEOBDynamicsArray(REAL8Array **ret_dyn, INT length, REAL8Array *dyn_inv)
{
    INT i, j;
...
void SEOBConcactInverseDynToAdaSDyn(REAL8Array **dyn_out, REAL8Array *dyn_inv, INT *retLen_out, INT retLen_inv)
{
    ...
    *retLen_out = retLen;
    for (i = 0; i < 15; i++)
    {
        ...
        memcpy(dyn_conc->data + i * retLen + retLen_inv - 1, dyn_adas->data + i * retLenAdaS,
               retLenAdaS * sizeof(REAL8));
    }
                                  ...
                                  SpinEOBParams *seobParams, INT flagConstantSampling)
{
    INT retLen;
    UINT i;
    REAL8Array *dynamics_spinaligned_inverse = NULL;
    ...
    if (seobParams->alignedSpins)
    {
        ...
        values_spinaligned->data[2] = ICvalues->data[3] * cos(temp_phi) + ICvalues->data[4] * sin(temp_phi); // p_r^*
        ...
        */
        // XLALSpinPrecAlignedHiSRStopCondition_inverse
        integrator =
            XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_inverse,
                                        XLALSpinPrecAlignedHiSRStopCondition_inverse, EPS_ABS, EPS_REL);
    }
    else
    {
        // Prec
        // XLALEOBSpinPrecStopConditionBasedOnPR_inverse
        integrator = XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables, XLALSpinPrecHcapNumericalDerivative_inverse,
                                                 XLALEOBSpinPrecStopConditionBasedOnPR_inverse, EPS_ABS, EPS_REL);
    }
    ...
    if (seobParams->alignedSpins)
    {
        ...
        if (!flagConstantSampling)
            retLen =
                XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values_spinaligned->data, 0.,
                                                     tend - tstart, deltaT, deltaT_min, &dynamics_spinaligned_inverse);
        else
            retLen = XLALAdaptiveRungeKutta4(integrator, seobParams, values_spinaligned->data, 0., tend - tstart,
                                             deltaT, &dynamics_spinaligned_inverse);
        ...
        // sort dynamics
        SortSEOBDynamicsArray_aligned(&dynamics_spinaligned, retLen, dynamics_spinaligned_inverse);
        STRUCTFREE(dynamics_spinaligned_inverse, REAL8Array);
        /* Convert the spin-aligned dynamics to a generic-spins dynamics */
        PRINT_LOG_INFO(LOG_INFO, "Convert Spin Aligned Dynamics to Generic Spins");
        status = SEOBConvertSpinAlignedDynamicsToGenericSpins(dynamics, dynamics_spinaligned, retLen, seobParams->chi1,
                                                              seobParams->chi2, seobParams);
    ...
    else
    {
        // Prec
        if (!flagConstantSampling)
            retLen = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values->data, 0., tend - tstart,
                                                          deltaT, deltaT_min, &dynamics_inverse);
        else
            retLen = XLALAdaptiveRungeKutta4(integrator, seobParams, values->data, 0., tend - tstart, deltaT,
                                             &dynamics_inverse);
        if (retLen < 0)
        {
            PRINT_LOG_INFO(LOG_CRITICAL, "Integration Failed!!!");
        ...
        // sort dynamics
        SortSEOBDynamicsArray(dynamics, retLen, dynamics_inverse);
                          ...
                          INT flagConstantSampling)
{
    ...
    if (seobParams->alignedSpins)
    {
        ...
        */
        if (tstart > 0)
        {
            ...
            if (seobParams->e0 != 0)
                integrator =
                    XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative,
    ...
    else
    {
        ...
        if (tstart > 0)
        {
            integrator = XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables, XLALSpinPrecHcapNumericalDerivative,
    ...
    if (seobParams->alignedSpins)
    {
        ...
        PRINT_LOG_INFO(LOG_INFO, "Adaptive RungeKutta4 No Interpolation");
        if (!flagConstantSampling)
            retLen = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values_spinaligned->data, 0.,
                                                          tend - tstart, deltaT, deltaT_min, &dynamics_spinaligned);
        else
            retLen = XLALAdaptiveRungeKutta4(integrator, seobParams, values_spinaligned->data, 0., tend - tstart,
    ...
    else
    {
        ...
        if (!flagConstantSampling)
            ...
            retLen = XLALAdaptiveRungeKutta4(integrator, seobParams, values->data, 0., tend - tstart, deltaT, dynamics);
        if (retLen < 0)
        {
            PRINT_LOG_INFO(LOG_CRITICAL, "Integration Failed!!!");
            failed = 1;
        ...
        */
        if (tstart > 0)
        {
            ...
            if (seobParams->e0 != 0)
                integrator =
                    XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative,
                                                EOBHighSRStopConditionEcc_withFMax, EPS_ABS, EPS_REL);
            else
                integrator =
                    XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative,
                                                XLALSpinPrecAlignedHiSRStopCondition_withFMax, EPS_ABS, EPS_REL);
        }
        else
        {
            // Low sampling
            integrator =
                XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative,
                                            XLALEOBSpinPrecAlignedStopCondition_withFMax, EPS_ABS, EPS_REL);
        }
    }
    else
    {
        ...
        {
            integrator = XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables, XLALSpinPrecHcapNumericalDerivative,
                                                     XLALEOBSpinPrecStopConditionBasedOnPR_withFMax, EPS_ABS, EPS_REL);
        }
        else
        {
            integrator = XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables, XLALSpinPrecHcapNumericalDerivative,
...
void SortSEOBDynamicsArray_SA(REAL8Array **ret_dyn, INT length, REAL8Array *dyn_inv)
{
    INT i, j;
    ...
    for (i = 0; i < length; i++)
    {
        ...
        //     dyn_inv->data[i], dyn_inv->data[i + length], dyn_inv->data[i +
        //     2*length], dyn_inv->data[i + 3*length], dyn_inv->data[i+4*length],
        //     dyn_inv->data[i+5*length], dyn_inv->data[i + 6*length],
        //     dyn_inv->data[i+7*length]);
        dyn->data[i] = -dyn_inv->data[length - 1 - i];
        for (j = 1; j < 8; j++)
            dyn->data[i + j * length] = dyn_inv->data[length - 1 - i + j * length];
    }
                                     ...
                                     SpinEOBParams *seobParams)
{
    ...
    // Low sampling
    integrator =
        XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_SA_inverse,
    ...
    PRINT_LOG_INFO(LOG_INFO, "Adaptive RungeKutta4 No Interpolation");
    retLen =
        XLALAdaptiveRungeKutta4NoInterpolateWithDeriv(integrator, seobParams, values_spinaligned->data, 0.,
                                                      tend - tstart, deltaT, deltaT_min, &dynamics_spinaligned_inverse);
    ...
    SortSEOBDynamicsArray_SA(&dynamics_spinaligned, retLen, dynamics_spinaligned_inverse);
    STRUCTFREE(dynamics_spinaligned_inverse, REAL8Array);
                             ...
                             REAL8 deltaT, REAL8 deltaT_min, REAL8 tstart, REAL8 tend, SpinEOBParams *seobParams)
{
    ...
    if (tstart > 0)
    {
        ...
        if (seobParams->e0 != 0)
            integrator =
                XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_SA,
                                            EOBHighSRStopConditionEcc, EPS_ABS, EPS_REL);
        else
            integrator =
                XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_SA,
    ...
    if (tstart > 0)
    {
        ...
        retLen = XLALAdaptiveRungeKutta4WithDeriv(integrator, seobParams, values_spinaligned->data, 0., tend - tstart,
                                                  deltaT, &dynamics_spinaligned);
    }
    else
    {
                                   ...
                                   SpinEOBParams *seobParams, INT flagConstantSampling)
{
    ...
    if (seobParams->alignedSpins)
    {
        ...
        */
        if (CONSERVE_FLAG == 0)
        {
            ...
            //         nb_Hamiltonian_variables_spinsaligned,
            //         XLALSpinAlignedHcapDerivative, EOBHighSRStopConditionEcc,
            //         EPS_ABS, EPS_REL);
            // else
        ...
        {
            // Low sampling
            PRINT_LOG_INFO(LOG_INFO, "Set conserved dynamics : "
                                     "XLALSpinAlignedHcapDerivative_Conserve");
            integrator = XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned,
                                                     XLALSpinAlignedHcapDerivative_Conserve,
                                                     XLALEOBSpinPrecAlignedStopCondition, EPS_ABS, EPS_REL);
        }
    }
    else
    {
        ...
        if (CONSERVE_FLAG == 0)
        {
            PRINT_LOG_INFO(LOG_INFO, "Set unconserved prec dynamics : "
        ...
        {
            PRINT_LOG_INFO(LOG_INFO, "Set conserved prec dynamics : "
                                     "XLALSpinPrecHcapNumericalDerivative_Conserve");
            integrator =
                XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables, XLALSpinPrecHcapNumericalDerivative_Conserve,
                                            XLALEOBSpinPrecStopConditionBasedOnPR, EPS_ABS, EPS_REL);
        }
    }
    ...
    if (seobParams->alignedSpins)
    {
        ...
        if (!flagConstantSampling)
        {
            PRINT_LOG_INFO(LOG_INFO,
                           "Run Integrator : "
                           "XLALAdaptiveRungeKutta4NoInterpolate, tend = %f",
                           time_end - tstart);
            retLen = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values_spinaligned->data, 0.,
                                                          time_end - tstart, deltaT, deltaT_min, &dynamics_spinaligned);
        }
        else
        {
            PRINT_LOG_INFO(LOG_INFO, "Run Integrator : XLALAdaptiveRungeKutta4, tend = %f", time_end - tstart);
            retLen = XLALAdaptiveRungeKutta4(integrator, seobParams, values_spinaligned->data, 0., time_end - tstart,
                                             deltaT, &dynamics_spinaligned);
        }
    ...
    else
    {
        ...
        if (!flagConstantSampling)
        {
            PRINT_LOG_INFO(LOG_INFO,
                           ...
                           "XLALAdaptiveRungeKutta4NoInterpolate, tend = %f",
                           time_end - tstart);
            retLen = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values->data, 0., time_end - tstart,
                                                          deltaT, deltaT_min, dynamics);
        }
        else
        {
            PRINT_LOG_INFO(LOG_INFO, "Run Integrator : XLALAdaptiveRungeKutta4, tend = %f", time_end - tstart);
            retLen =
                XLALAdaptiveRungeKutta4(integrator, seobParams, values->data, 0., time_end - tstart, deltaT, dynamics);
        }
        if (retLen < 0)
        {
            PRINT_LOG_INFO(LOG_CRITICAL, "Integration Failed!!!");
...
#if 1
INT TortoiseConvertMatrix(SpinEOBParams *params, REAL8 values[], REAL8 dvalues[], REAL8 pVecRet[])
{
    int i, j;
    REAL8 eta = params->eta;
    ...
    prT = pData[0] * (rData[0] / rMag) + pData[1] * (rData[1] / rMag) + pData[2] * (rData[2] / rMag);
    ...
    eobD_r = (u2 / (D * D)) * (12. * eta * u + 6. * (26. - 3. * eta) * eta * u2) /
             (1. + 6. * eta * u2 + 2. * (26. - 3. * eta) * eta * u3);
    m1PlusetaKK = -1. + eta * coeffs->KK;
    /* Eq. 5.75 of BB1 */
    bulk = 1. / (m1PlusetaKK * m1PlusetaKK) + (2. * u) / m1PlusetaKK + a2 * u2;
    /* Eq. 5.73 of BB1 */
    logTerms = 1. + eta * coeffs->k0 +
               eta * log(fabs(1. + coeffs->k1 * u + coeffs->k2 * u2 + coeffs->k3 * u3 + coeffs->k4 * u4 +
    ...
    for (i = 0; i < 3; i++)
        for (j = 0; j <= i; j++)
        {
            Tmatrix[i][j] = Tmatrix[j][i] = (rData[i] * rData[j] / rMag2) * (csi - 1.);

            invTmatrix[i][j] = invTmatrix[j][i] = -(csi - 1) / csi * (rData[i] * rData[j] / rMag2);
...
INT CutSEOBSAdynamics(SEOBSAdynamics **eobdyn, REAL8 MfMin)
{
    ...
    // print_debug("here: (%d, %d)\n", dyn_new->array->dimLength->data[0],
    // dyn_new->array->dimLength->data[1]);
                                    ...
                                    SpinEOBParams *seobParams)
{
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        status = XLALSpinPrecHcapRvecDerivative(0, values->data, dvalues->data, (void *)seobParams);
        if (status != CEV_SUCCESS)
        {
            failed = 1;
            goto QUIT;
        ...
        // S1 = sqrt((spin1vec[0]*spin1vec[0] + spin1vec[1]*spin1vec[1] +
        // spin1vec[2]*spin1vec[2]))/m1sq; S2 = sqrt((spin2vec[0]*spin2vec[0] +
        // spin2vec[1]*spin2vec[1] + spin2vec[2]*spin2vec[2]))/m2sq;

        c1x = inner_product3d(spin1vec, rvec) / polarr / m1sq;
        c1z = inner_product3d(spin1vec, LNhat) / m1sq;
        // c1y = sqrt( (spin1vec[0]*spin1vec[0] + spin1vec[1]*spin1vec[1] +
        // spin1vec[2]*spin1vec[2])/(m1sq*m1sq) - c1x*c1x - c1z*c1z);
        ...
        // c2y = sqrt( (spin2vec[0]*spin2vec[0] + spin2vec[1]*spin2vec[1] +
        // spin2vec[2]*spin2vec[2])/(m2sq*m2sq) - c2x*c2x - c2z*c2z);
        ...
        //     print_debug("get r = %g, chi1 = (%g, %g, %g), chi2 = (%g, %g,
        //     %g)\n", polarr,
        ...
        if (sKerr_norm > 1e-6)
        {
            ...
            S_con /= (1 - 2 * eta);
            S_con += (inner_product3d(S1_perp, sigmaKerr->data) + inner_product3d(S2_perp, sigmaKerr->data)) /
        ...
        ham = XLALSimIMRSpinPrecEOBHamiltonian(eta, &cartPosVec, &cartMomVec, &s1Vec, &s2Vec, sigmaKerr, sigmaStar,
                                             ...
                                             SpinEOBParams *seobParams)
{
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        REAL8 c_prDot, c_pr;
#if 1
        flux = XLALInspiralPrecSpinFactorizedFlux(&polarDynamics, &cartDynamics, NULL, omega, dr, ncrv, seobParams, ham,
                                                  8, 4);
        // print_debug("%.16e\n", flux);
        // // DEBUG: Fr and Ff
        REAL8 tmpP[3];
        TortoiseConvertMatrix(seobParams, values->data, dvalues->data, tmpP);
        c_pr = (tmpP[0] * rvec[0] + tmpP[1] * rvec[1] + tmpP[2] * rvec[2]) / polarr;
        c_prDot = -dr * c_pr / polarr +
                  (rvec[0] * dvalues->data[3] + rvec[1] * dvalues->data[4] + rvec[2] * dvalues->data[5] +
                   rdotvec[0] * tmpP[0] + rdotvec[1] * tmpP[1] + rdotvec[2] * tmpP[2]) /
                      polarr -
                  flux * c_pr / eta / polarpphi;
        // CalculateEccCorrectionToFlux(eta, c1z, c2z, polarr, dr, c_prDot, &cFr,
        // &cFf); CalculateEccCorrectionToFluxV2(eta, c1z, c2z, polarr, polarpr,
        // c_prDot, &cFr, &cFf);
        CalculateEccCorrectionToFluxV3(eta, c1z, c2z, polarr, dr, c_prDot, &cFr, &cFf, seobParams->e0);
        // prDot = dvalues[2] - ( values[2] / values[3] / csi ) * flux / omega;
        // CalculateEccCorrectionToFluxV3(eta, params.params->chi1,
        // params.params->chi1, r, dvalues[0], prDot, &cFr, &cFf,
        // params.params->e0); CalculateEccCorrectionToFluxV4(eta, c1z, c2z,
        // polarr, polarpr, c_prDot, &cFr, &cFf);
        // CalculateRRForceSpinCoeffs(&coeffsFf, &coeffsFr, seobParams->m1,
        // seobParams->m2, c1z, c2z); psq = pvec[0]*pvec[0] + pvec[1]*pvec[1] +
        // pvec[2]*pvec[2]; CalculateRRForce(&coeffsFf, &coeffsFr, &Ff, &Fr,
        // polarr, polarpr, psq, polarpphi);
#else
        cFr = 0.0;
        cFf = 0.0;
        flux = 0.0;
...
)
{
    ...
    {
        PRINT_LOG_INFO(LOG_CRITICAL, "time %f for interpolation is out of range of (%f, %f)", t, tVec[0],
                       tVec[retLen - 1]);
        return CEV_FAILURE;
        ;
    }
    ...
    {
        status = gsl_spline_init(spline, &(tVec[indexstart]), &(seobdynamics->array->data[j * retLen + indexstart]),
                                 interp_length);
        if (status != GSL_SUCCESS)
        {
            is_failed = 1;
...
)
{
    ...
    for (j = 1; j < 5; j++)
    {
        ...
        (*seobdynamics_values)->data[j] = gsl_spline_eval(spline, t, acc);
        // status = gsl_spline_eval_e(spline, t, acc,
        // &((*seobdynamics_values)->data[j])); print_debug("status2 = %d\n",
        // status); if (status != GSL_SUCCESS)
        // {
        //     gsl_spline_free(spline);
        //     gsl_interp_accel_free(acc);
        //     return CEV_FAILURE;
                      ...
                      INT flagZframe)
{
    ...
    {
        // Note: pvec is missing a factor of nu, but don't care about it's
        // magnitide anyway
...
int SEOBJfromDynamics(REAL8Vector **J,          /**<< Output: pointer to vector J */
                      REAL8Vector *seobvalues,  /**<< Input: vector for extended
                                                   dynamics values */
                      SpinEOBParams *seobParams /**<< SEOB params */
)
{
...
)
{
    ...
    */
    ...
    /* NOTE: internally, XLALSimIMRSpinEOBCalculateNQCCoefficientsV4 builds a
     * time vector as i*deltaT, starting at 0 - thus tPeakOmega has to be
     * measured from the start of the dynamics */
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        /* In the equal mass equal spins case the odd-m modes are 0, so we set
         * the NQCs to 0 */
        ...
        else
        {
            ...
            includeNQC = 0;
            hlm = NULL;
            // PRINT_LOG_INFO(LOG_DEBUG, "here, calc Amp Phase: (l,m) = (%d,%d)",
            // l, m); if (l==2 && m==1)
            //     DEBUG_START;
            SEOBCalculatehlmAmpPhase(&hlm, l, m, seobdynamics, nqcCoeffs, seobParams, includeNQC);
            // if (l==2 && m==1)
            //     DEBUG_END;
            ...
            memcpy(hlm_amp->data, hlm->camp_real->data, hlm->xdata->length * sizeof(REAL8));
            memcpy(hlm_phase->data, hlm->phase->data, hlm->xdata->length * sizeof(REAL8));

            /* Compute NQC */
            // PRINT_LOG_INFO(LOG_DEBUG, "here, calc NQC start: (l,m) = (%d,%d)",
            // l, m);
            if (XLALSimIMRSpinEOBCalculateNQCCoefficientsV4(hlm_amp, hlm_phase, &r, &pr, &omega, l, m,
                                                            tPeakOmegaFromStartDyn, seobdynamics->tVec[0], deltaT, m1,
                                                            m2, chiAfinal, chiSfinal, seobParams->tWind,
                                                            seobParams->wWind, nqcCoeffs, seobParams) == CEV_FAILURE)
            {
            ...
            // PRINT_LOG_INFO(LOG_DEBUG, "here, calc NQC end: (l,m) = (%d,%d)",
            // l, m);
            /* Cleanup */
#if 0
        CHAR fname[256];
        ...
        // PRINT_LOG_INFO(LOG_DEBUG, "here, Add computed NQCs to the list: (l,m)
        // =
        // (%d,%d)", l, m);
    ...
    SpinEOBParams *seobParams)
{
    ...
    */
    ...
    REAL8 tPeakOmegaFromStartDyn = tPeakOmega - seobdynamics->tVec[0];
    PRINT_LOG_INFO(LOG_DEBUG,
                   "tPeak = %.16e, t0 = %.16e, tend = %.16e, "
                   "tPeakOmegaFromStartDyn = %.16e",
                   tPeakOmega, seobdynamics->tVec[0], seobdynamics->tVec[retLen - 1] - seobdynamics->tVec[0],
                   tPeakOmegaFromStartDyn);
    /* Compute NQC coefficients - output is nqcCoeffs */
    /* NOTE: internally, XLALSimIMRSpinEOBCalculateNQCCoefficientsV4 builds a
     * time vector as i*deltaT, starting at 0 - thus tPeakOmega has to be
     * measured from the start of the dynamics */
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        else
        {
            ...
            hlm = NULL;
            // PRINT_LOG_INFO(LOG_DEBUG, "here, calc Amp Phase: (l,m) = (%d,%d)",
            // l, m); SEOBCalculatehlmAmpPhase(&hlm, l, m, seobdynamics,
            // nqcCoeffs, seobParams,
            //                         includeNQC);
            // print_debug("(%d,%d)calc SA ampphase\n", l, m);
            // if (l==2 && m==1)
            //     DEBUG_START;
            SEOBSACalculatehlmAmpPhase(&hlm, l, m, seobdynamics, nqcCoeffs, seobParams, includeNQC);
            // if (l==2 && m==1)
            //     DEBUG_END;
...
)
{
    ...
    if (SEOBLFrameVectors(&chi1temp, &chi2temp, seobvalues, m1, m2, seobParams->hParams->flagZframe) == CEV_FAILURE)
    {
    ...
    // print_debug("chi1L = %.16e, chi2L = %.16e, m1 = %.16e, m2 = %.16e,
    // finalmass = %.16e, finalspin = %.16e\n",
...
)
{
    ...
    // REAL8Vector *chi1temp = NULL;
    // REAL8Vector *chi2temp = NULL;
    // if (SEOBLFrameVectors(&chi1temp, &chi2temp, seobvalues, m1, m2,
    // seobParams->hParams->flagZframe) ==
    //     CEV_FAILURE)
    // {
    //     PRINT_LOG_INFO(LOG_CRITICAL, "failure in SEOBLFrameVectors.");
    //     failed = 1;
...
)
{
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failed to allocate CAmpPhaseSequence hlm for mode "
                           "(l,m) = (%d,%d).",
                           l, m);
            return CEV_FAILURE;
        }
    ...
    *sigmaQNMlm0 = CreateCOMPLEX16Vector(nmodes);
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        /* NOTE: XLALSimIMREOBGenerateQNMFreqV2Prec returns the complex frequency
         * in physical units... */
        if (XLALSimIMREOBGenerateQNMFreqV2FromFinalPrec(&sigmaQNMlm0physicalVec, m1, m2, finalM, finalS, l, m, 1) ==
            CEV_FAILURE)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMREOBGenerateQNMFreqV2FromFinalPrec "
                           "for mode (l,m) = (%d,%d).",
                           l, m);
            failed = 1;
            goto QUIT;
        ...
        // if (debug) {
        //     XLAL_PRINT_INFO("Complex QNM frequency: (%d,%d,0) = %.16e +
        //     I*%.16e\n", l,
    ...
    REAL8 timeNeartAttach55 = FindClosestValueInIncreasingVector(&timeVec, tAttach - 10.);
    /* This structure is inherited from the time when the attachment was done
     * with a comb */
    ...
    rdMatchPoint.data[1] = timeNeartAttach;   /* this is the time closest to tAttach */
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        CAmpPhaseSequence *hPlm = SphHarmListCAmpPhaseSequence_GetMode(listhPlm, l, m)->campphase;
        ...
        for (i = 0; i < retLen; i++)
        {
            hPlm_val = (hPlm->camp_real->data[i] + I * hPlm->camp_imag->data[i]) * cexp(I * hPlm->phase->data[i]);
        ...
        if (XLALSimIMREOBAttachFitRingdown(hPlmRe, hPlmIm, l, m, deltaTseconds, m1, m2, chi1Lx, chi1Ly, chi1Lz, chi2Lx,
                                           chi2Ly, chi2Lz, finalM, finalS, &timeVec, &rdMatchPoint,
                                           &indAmpMax) == CEV_FAILURE)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "XLALSimIMREOBAttachFitRingdown failed for mode "
                           "(l,m) = (%d,%d).",
                           l, m);
            failed = 1;
            goto QUIT;
        ...
        {
            hPlm_RDattached->xdata->data[retLen + i] = hPlm_RDattached->xdata->data[retLen - 1] + i * deltaT;
        }
...
)
{
    ...
    REAL8Vector *hPlmRe = NULL;
    REAL8Vector *hPlmIm = NULL;
    // SEOBLFrameVectors(&chi1temp, &chi2temp, seobvalues, m1, m2,
    // seobParams->hParams->flagZframe);
...
)
{
    ...
    *retLenPmodes = lenPmodes;
    ...
    {
        (*tVecPmodes)->data[iJoinHiS + lenHiS + i] = tHiS[lenHiS - 1] + (i + 1) * deltaTHiS;
    }
...
)
{
    ...
    *tJoinAttach = (*tVecPmodes)->data[iJoinAttach];
    ...
    //     seobdynamicsAdaS->tVec[j], seobdynamicsAdaS->rVec[j],
    //     seobdynamicsAdaS->phiVec[j], seobdynamicsAdaS->prTVec[j],
    //     seobdynamicsAdaS->pphiVec[j], seobdynamicsAdaS->drVec[j],
    //     seobdynamicsAdaS->dphiVec[j], seobdynamicsAdaS->dprTVec[j],
    //     seobdynamicsAdaS->dpphiVec[j], seobdynamicsAdaS->HVec[j]);
...
)
{
    ...
    *seobdynamicsJoined = CreateSEOBdynamics(lenJoined);
    ...
    {
        memcpy(&((*seobdynamicsJoined)->array->data[j * lenJoined]), &(seobdynamics1->array->data[j * lendyn1]),
    ...
    for (j = 0; j < v4PdynamicsVariables; j++)
    {
        memcpy(&((*seobdynamicsJoined)->array->data[j * lenJoined + lendyn1Joined]),
               &(seobdynamics2->array->data[j * lendyn2]), lendyn2Joined * sizeof(REAL8));
    }
...
)
{
    ...
    *seobdynamicsJoined = CreateSEOBSAdynamics(lenJoined);
    ...
    j = 0;
    // print_debug("%d, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e\n", j,
    //     seobdynamics1->tVec[j], seobdynamics1->rVec[j],
    //     seobdynamics1->phiVec[j], seobdynamics1->prTVec[j],
    //     seobdynamics1->pphiVec[j], seobdynamics1->drVec[j],
    //     seobdynamics1->dphiVec[j], seobdynamics1->dprTVec[j],
    //     seobdynamics1->dpphiVec[j], seobdynamics1->HVec[j]);
    // j = lendyn1-1;
    // print_debug("%d, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e\n", j,
    //     seobdynamics1->tVec[j], seobdynamics1->rVec[j],
    //     seobdynamics1->phiVec[j], seobdynamics1->prTVec[j],
    ...
    // j = 0;
    // print_debug("%d, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e\n", j,
    //     seobdynamics2->tVec[j], seobdynamics2->rVec[j],
    //     seobdynamics2->phiVec[j], seobdynamics2->prTVec[j],
    //     seobdynamics2->pphiVec[j], seobdynamics2->drVec[j],
    //     seobdynamics2->dphiVec[j], seobdynamics2->dprTVec[j],
    //     seobdynamics2->dpphiVec[j], seobdynamics2->HVec[j]);
    // j = lendyn2-1;
    // print_debug("%d, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e\n", j,
    //     seobdynamics2->tVec[j], seobdynamics2->rVec[j],
    //     seobdynamics2->phiVec[j], seobdynamics2->prTVec[j],
    ...
    /* Copy truncated dynamics 1 - v4PdynamicsVariables data fields */
    // print_debug("Copy truncated dynamics 1 - v4PdynamicsVariables data
    // fields\n");
    ...
    for (j = 0; j < v4SAdynamicsVariables; j++)
    {
        // print_debug("Copy truncated dynamics 2 - v4PdynamicsVariables data
        // fields: %d\n", j);
        memcpy(&((*seobdynamicsJoined)->array->data[j * lenJoined + lendyn1Joined]),
               &(seobdynamics2->array->data[j * lendyn2]), lendyn2Joined * sizeof(REAL8));
    }
...
)
{
    ...
    /* Check lengths */
    if ((!(hP22->xdata->length == length)) || (found21 && !(hP21->xdata->length == length)))
    {
    ...
    UINT indexMax = 0, i;
    REAL8 AsquareMax = 0.;
    REAL8 A22_real = 0., A22_imag = 0., A21_real = 0., A21_imag = 0., Asquare = 0.;
    for (i = 0; i < length; i++)
    {
...
)
{
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        /* Get the relevant modes in lists */
        CAmpPhaseSequence *hlm_1 = SphHarmListCAmpPhaseSequence_GetMode(listhlm_1, l, m)->campphase;
        CAmpPhaseSequence *hlm_2 = SphHarmListCAmpPhaseSequence_GetMode(listhlm_2, l, m)->campphase;
        ...
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failed to allocate CAmpPhaseSequence hlm_joined for mode "
                           "(l,m) = (%d,%d).",
                           l, m);
            return CEV_FAILURE;
        }
        ...
        memcpy(&(hlm_joined->xdata->data[0]), hlm_1->xdata->data, lenJoined1 * sizeof(REAL8));
        memcpy(&(hlm_joined->camp_real->data[0]), hlm_1->camp_real->data, lenJoined1 * sizeof(REAL8));
        memcpy(&(hlm_joined->camp_imag->data[0]), hlm_1->camp_imag->data, lenJoined1 * sizeof(REAL8));
        memcpy(&(hlm_joined->phase->data[0]), hlm_1->phase->data, lenJoined1 * sizeof(REAL8));
        /* Copy data, for part 2 starting from the specified index */
        memcpy(&(hlm_joined->xdata->data[lenJoined1]), hlm_2->xdata->data, len2 * sizeof(REAL8));
        memcpy(&(hlm_joined->camp_real->data[lenJoined1]), hlm_2->camp_real->data, len2 * sizeof(REAL8));
        memcpy(&(hlm_joined->camp_imag->data[lenJoined1]), hlm_2->camp_imag->data, len2 * sizeof(REAL8));
        memcpy(&(hlm_joined->phase->data[lenJoined1]), hlm_2->phase->data, len2 * sizeof(REAL8));
        /* Adjust for a 2kpi-shift in the phase - use the difference between the
         * last included sample of 1 and the first sample of 2 */
        REAL8 phase_diff = hlm_2->phase->data[0] - hlm_1->phase->data[lenJoined1 - 1];
        REAL8 shift_2kpi = -floor((phase_diff + CST_PI) / (2 * CST_PI)) * (2 * CST_PI);
        for (i = 0; i < len2; i++)
        {
...
)
{
    ...
    {
        PRINT_LOG_INFO(LOG_CRITICAL, "failed to allocate REAL8Vector alphaJ2P.");
        return CEV_FAILURE;
    }
                                ...
                                angles to 0 */
    {
        ...
        /* Loop over time samples to compute alpha and beta, stopping at
         * retLenDyn
         */
        for (i = 0; i < retLenDyn; i++)
        {
            ...
            /* At initial time, compute the initial vectors (e1P, e2P, e3P)
             * decomposed in the frame (e1J, e2J, e3J) */
        ...
        /* gamma is set initially so that the initial P-frame reproduces the
         * initial (n, lambda, Lhat or LNhat) frame */
        ...
        for (i = 0; i < retLenDyn; i++)
        {
            ...
            {
                gsl_integration_qags(&precEulerF, tVec[i - 1], tVec[i], 1e-9, 1e-9, 1000, precEulerw, &precEulerresult,
                                     &precEulererror);
        ...
        /* Unwrap gamma in-place -- note that with integration, this should not
         * be necessary */
...
)
{
    ...
    if (!SpinsAlmostAligned)
    {
        ...
        if (1 /*flagEulerextension == FLAG_SEOBNRv4P_EULEREXT_QNM_SIMPLE_PRECESSION*/)
        {
            ...
            // flip is either 1 or -1. This is needed because we want the sign of
            // the precession frequency to be correct even when the projected
            // final spin is negative, at which point the QNMs flip sign
            precRate *= flip;
            REAL8 cosbetaAttach = cos(betaAttach);
            for (i = indexStart; i < retLen; i++)
            {
                alphaJ2P->data[i] = alphaAttach + (tVec->data[i] - timeAttach) * precRate;
                betaJ2P->data[i] = betaAttach;
                gammaJ2P->data[i] = gammaAttach - cosbetaAttach * (tVec->data[i] - timeAttach) * precRate;
            }
        }
    ...
    {
        memset(&(alphaJ2P->data[indexStart]), 0, (retLen - indexStart) * sizeof(REAL8));
        memset(&(betaJ2P->data[indexStart]), 0, (retLen - indexStart) * sizeof(REAL8));
        memset(&(gammaJ2P->data[indexStart]), 0, (retLen - indexStart) * sizeof(REAL8));
    }
...
)
{
    ...
    *hJlm = NULL;
    ...
    gsl_spline *spline_Dlmmp_phase = gsl_spline_alloc(gsl_interp_cspline, retLenP);
    gsl_spline *spline_Dlmminusmp_amp = gsl_spline_alloc(gsl_interp_cspline, retLenP);
    gsl_spline *spline_Dlmminusmp_phase = gsl_spline_alloc(gsl_interp_cspline, retLenP);
    ...
    /* Interpolate P-frame modes hPlm on the time samples needed for the output
     * as a time series */
    ...
    for (nmode = 0; nmode < nmodes; nmode++)
    {
        ...
        status = gsl_spline_init(spline_camp_real, tVecPmodes->data, hPlm->camp_real->data, retLenP);
        if (status != GSL_SUCCESS)
        {
            is_failed = 1;
            goto QUIT;
        }
        status = gsl_spline_init(spline_camp_imag, tVecPmodes->data, hPlm->camp_imag->data, retLenP);
        if (status != GSL_SUCCESS)
        {
            is_failed = 1;
            goto QUIT;
        ...
        {
            t = timeTSdata[i];
            /* Here we include a possible imaginary part of the complex envelope,
             * but at the moment it is simply 0 (only real part is used) */
    ...
    for (l = 2; l <= modes_lmax; l++)
    {
        ...
        for (m = -l; m <= l; m++)
        {
            ...
            for (nmode = 0; nmode < nmodes; nmode++)
            {
                ...
                CAmpPhaseSequence *hPlmp_TS = SphHarmListCAmpPhaseSequence_GetMode(listhPlm_TS, l, mp)->campphase;
                hPlmp_campreal_data = hPlmp_TS->camp_real->data;
                hPlmp_campimag_data = hPlmp_TS->camp_imag->data;

                /* Compute Wigner coefficients amp/phase on the same input
                 * sampling as the P-frame modes */
                for (i = 0; i < retLenP; i++)
                {
                    alpha = alphadata[i];
                    beta = betadata[i];
                ...
                status = gsl_spline_init(spline_Dlmmp_amp, tVecPmodes->data, Dlmmp_amp->data, retLenP);
                if (status != GSL_SUCCESS)
                {
                    is_failed = 1;
                    goto QUIT;
                }
                status = gsl_spline_init(spline_Dlmmp_phase, tVecPmodes->data, Dlmmp_phase->data, retLenP);
                if (status != GSL_SUCCESS)
                {
                    is_failed = 1;
                    goto QUIT;
                ...
                if (flagSymmetrizehPlminusm)
                {
                    status = gsl_spline_init(spline_Dlmminusmp_amp, tVecPmodes->data, Dlmminusmp_amp->data, retLenP);
                    if (status != GSL_SUCCESS)
                    {
                        is_failed = 1;
                        goto QUIT;
                    ...
                    status =
                        gsl_spline_init(spline_Dlmminusmp_phase, tVecPmodes->data, Dlmminusmp_phase->data, retLenP);
                    if (status != GSL_SUCCESS)
                    {
                        is_failed = 1;
                        goto QUIT;
                ...
                for (i = 0; i < retLenTS; i++)
                {
                    ...
                    Dlmmp_phase_val = gsl_spline_eval(spline_Dlmmp_phase, t, accel_Dlmmp_phase);
                    Dlmmp_val = Dlmmp_amp_val * cexp(-I * Dlmmp_phase_val); /* mind the conjugation
                                                                               Dlmmpstar */
                    hPlmp_val = hPlmp_campreal_data[i] + I * hPlmp_campimag_data[i];
                    hJlmmode_data[i] += Dlmmp_val * hPlmp_val;
                    if (flagSymmetrizehPlminusm)
                    {
                        Dlmminusmp_amp_val = gsl_spline_eval(spline_Dlmminusmp_amp, t, accel_Dlmminusmp_amp);
                        Dlmminusmp_phase_val = gsl_spline_eval(spline_Dlmminusmp_phase, t, accel_Dlmminusmp_phase);
                        Dlmminusmp_val = Dlmminusmp_amp_val * cexp(-I * Dlmminusmp_phase_val); /* mind the
                                                                                                  conjugation
                                                                                                  Dlmminusmpstar */
...
)
{
    ...
    *hJlm = NULL;
    ...
    /* Interpolating splines for Wigner coefficients */
    // gsl_spline *spline_Dlmmp_amp = gsl_spline_alloc(gsl_interp_cspline,
    // retLenP); gsl_spline *spline_Dlmmp_phase =
    ...
    /* Interpolating splines for hPlm modes */
    // gsl_spline *spline_camp_real = gsl_spline_alloc(gsl_interp_cspline,
    // retLenP); gsl_spline *spline_camp_imag =
    // gsl_spline_alloc(gsl_interp_cspline, retLenP); gsl_spline *spline_phase =
    // gsl_spline_alloc(gsl_interp_cspline, retLenP); gsl_interp_accel
    // *accel_camp_real = gsl_interp_accel_alloc(); gsl_interp_accel
    // *accel_camp_imag = gsl_interp_accel_alloc(); gsl_interp_accel *accel_phase
    ...
    for (l = 2; l <= modes_lmax; l++)
    {
        ...
        for (m = -l; m <= l; m++)
        {
            ...
            /* Get interpolated mode hPlmp */
            // CAmpPhaseSequence *hPlmp_TS =
            //     SphHarmListCAmpPhaseSequence_GetMode(listhPlm, l,
            //     m)->campphase;
            // hPlmp_campreal_data = hPlmp_TS->camp_real->data;
            // hPlmp_campimag_data = hPlmp_TS->camp_imag->data;
            // for (i = 0; i < retLenTS; i++)
            // {
            //     hPlmp_val = hPlmp_campreal_data[i] + I *
            //     hPlmp_campimag_data[i]; hJlmmode_data[i] = hPlmp_val;
            // }
            // print_debug("l,m = (%d, %d)\n", l, m);
            ...
            for (nmode = 0; nmode < nmodes; nmode++)
            {
                ...
                /* Get interpolated mode hPlmp */
                CAmpPhaseSequence *hPlmp_TS = SphHarmListCAmpPhaseSequence_GetMode(listhPlm, l, mp)->campphase;
                hPlmp_campreal_data = hPlmp_TS->camp_real->data;
                hPlmp_campimag_data = hPlmp_TS->camp_imag->data;
                ...
                {
                    t = timeTSdata[i];
                    // Dlmmp_amp_val = gsl_spline_eval(spline_Dlmmp_amp, t,
                    // accel_Dlmmp_amp); Dlmmp_phase_val =
                    //     gsl_spline_eval(spline_Dlmmp_phase, t,
                    //     accel_Dlmmp_phase);
                    ...
                    // creal(hPlmp_val), cimag(hPlmp_val)); hPlmp_val = 0.0;
                    hJlmmode_data[i] += Dlmmp_val * hPlmp_val;
                    if (flagSymmetrizehPlminusm)
                    {
                        // Dlmminusmp_amp_val =
                        //     gsl_spline_eval(spline_Dlmminusmp_amp, t,
                        //     accel_Dlmminusmp_amp);
                        // Dlmminusmp_phase_val =
                        // gsl_spline_eval(spline_Dlmminusmp_phase, t,
    ...
    for (l = 2; l <= modes_lmax; l++)
    {
        ...
        for (m = -l; m <= l; m++)
        {
            ...
            for (mp = -l; mp <= l; mp++)
            {
                ...
                D_wigner = amp_wigner * cexp(-I * phase_wigner); /* mind the conjugation Dlmmpstar */
                                   ...
                                   INT is_only22)
{
    ...
    for (l = 2; l <= modes_lmax; l++)
    {
        for (m = -l; m <= l; m++)
        {
            ...
            COMPLEX16 sYlm;
            // COMPLEX16 sYlm =
            //     XLALSpinWeightedSphericalHarmonic(inc, CST_PI / 2. - phi, -2,
            //     l, m);
                                         ...
                                         INT is_first, SpinEOBParams *seobParams)
{
    ...
    {
        if (dyn->polarrVec[i] < tThresh)
            continue;
        if (is_first)
        {
            dr_n = (dyn->posVecx[i] * dyn->velVecx[i] + dyn->posVecy[i] * dyn->velVecy[i] +
                    dyn->posVecz[i] * dyn->velVecz[i]) /
                   dyn->polarrVec[i];
            dr_o = (dyn->posVecx[i + 1] * dyn->velVecx[i + 1] + dyn->posVecy[i + 1] * dyn->velVecy[i + 1] +
                    dyn->posVecz[i + 1] * dyn->velVecz[i + 1]) /
                   dyn->polarrVec[i + 1];
            if (dr_n * dr_o < 0)
            {
                ip1 = i;
    ...
    // print_debug("tp1 = %g, tp2 = %g, thPeak = %g, tHi0 = %g, tr6 = %g, rp =
    // %g\n",
...
{
    EOBNonQCCoeffs *nqcCoeffs = SphHarmListEOBNonQCCoeffs_GetMode(listnqcCoeffs, ModeL, ModeM)->nqcCoeffs;
    // print_debug("nqc: a1 = %e, a2 = %e, a3 = %e\n", nqcCoeffs->a1,
    // nqcCoeffs->a2, nqcCoeffs->a3); print_debug("nqc: b1 = %e, b2 = %e\n",
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBNonQCCorrection at "
                           "step %d of the loop.",
                           i);
            return CEV_FAILURE;
        }
                                          ...
                                          COMPLEX16TimeSeries **out_new, COMPLEX16TimeSeries **out_old)
{
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        polarDynamics.data[3] = seobdynamics->polarpphiVec[i];
        v = cbrt(omega);
        if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform(&hLM1, &polarDynamics, &values, v, ham, ModeL, ModeM,
                                                           seobParams) != CEV_SUCCESS)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform at "
        ...
        if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2(&hLM2, &polarDynamics, &values, v, dr, ncrv,
                                                             seobdynamics->polarprDotVec[i], ham, ModeL, ModeM,
                                                             seobParams) != CEV_SUCCESS)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2 at "
                       ...
                       REAL8 tPeak)
{
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        if (CODE_VERSION == 0)
        {
            if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform(&hLM, &polarDynamics, &values, v, ham, ModeL, ModeM,
                                                               seobParams) != CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform "
        ...
        else
        {
            ...
            if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2(&hLM, &polarDynamics, &values, v, dr, ncrv,
                                                                 seobdynamics->polarprDotVec[i], ham, ModeL, ModeM,
                                                                 seobParams) != CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                         ...
                         SphHarmListEOBNonQCCoeffs *listnqcCoeffs, REAL8 tPeak)
{
    ...
    if (XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients(seobParams->hCoeffs, m1, m2, eta, tplspin, chiS, chiA, 451) ==
        CEV_FAILURE)
    {
        PRINT_LOG_INFO(LOG_CRITICAL, "failure in XLALSimIMREOBCalcSpinPrecFacWaveformCoefficients.");
        return CEV_FAILURE;
    ...
    for (i = 0; i < retLen; i++)
    {
        ...
        if (CODE_VERSION == 0)
        {
            if (XLALSimIMRSpinEOBGetSASpinFactorizedWaveform(&hLM, &polarDynamics, v, ham, ModeL, ModeM, seobParams) !=
                CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveform "
        ...
        else
        {
            ...
            if (XLALSimIMRSpinEOBGetSASpinFactorizedWaveformV2(&hLM, &polarDynamics, v, dr, ncrv, 0, ham, ModeL, ModeM,
                                                               seobParams) != CEV_SUCCESS)
            {
                PRINT_LOG_INFO(LOG_CRITICAL,
                               "failure in "
...
static int XLALEOBSpinPrecAlignedStopCondition_egw(double t,              /**< UNUSED */
                                                   const double values[], /**< dynamical variable values */
                                                   double dvalues[], /**< dynamical variable time derivative values */
                                                   void *funcParams  /**< physical parameters */
)
                              ...
                              SpinEOBParams *seobParams, INT flagConstantSampling)
{
    ...
    if (seobParams->alignedSpins)
    {
        ...
        */
        integrator =
            XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_SAConserve,
    ...
    if (seobParams->alignedSpins)
    {
        ...
        // EOBversion = 2
        PRINT_LOG_INFO(LOG_INFO, "Adaptive RungeKutta4 No Interpolation");
        retLen = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values_spinaligned->data, 0., 10., deltaT,
                                                      deltaT_min, &dynamics_spinaligned);
    ...
    {
        // Prec
        retLen = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, values->data, 0., 10., deltaT, deltaT_min,
                                                      dynamics);
        if (retLen < 0)
        {
            PRINT_LOG_INFO(LOG_CRITICAL, "Integration Failed!!!");
...
INT CalculateSAh22SeriesFromrpphi(REAL8 r, REAL8 pphi, SpinEOBParams *core, REAL8 *omega22, REAL8 *egw)
{
    ...
    deltaT = 0.5;
    deltaT_min = 8.0e-5;
    status = SEOBIntegrateDynamics_egw(&dynamicsAdaS, &retLenAdaS, ICvalues, EPS_ABS, EPS_REL, deltaT, deltaT_min, 0,
                                       10., core, core->alignedSpins);
    if (status != CEV_SUCCESS)
    {
        failed = 1;
        goto QUIT;
    ...
    for (UINT i = 0; i < retLenAdaS; i++)
    {
        ...
        dr = (seobdynamicsAdaS->posVecx[i] * seobdynamicsAdaS->velVecx[i] +
              ...
              seobdynamicsAdaS->posVecz[i] * seobdynamicsAdaS->velVecz[i]) /
        ...
        REAL8 v = cbrt(omega);
        if (XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2(&h22, &polarDynamics, &values, v, dr, ncrv,
                                                             seobdynamicsAdaS->polarprDotVec[i], ham, 2, 2,
                                                             core) != CEV_SUCCESS)
        {
            PRINT_LOG_INFO(LOG_CRITICAL,
                           "failure in XLALSimIMRSpinEOBGetPrecSpinFactorizedWaveformV2 at "
    ...
    for (int i = 0; i < retLenAdaS; i++)
    {
        ...
        //     seobdynamicsAdaS->polarrVec[i],
        //     h22Phase->data[i]);
        // h22Omega->data[i] = gsl_spline_eval_deriv(spline,
        // seobdynamicsAdaS->tVec[i], acc);
...
REAL8
calculate_L_from_omgezeta(REAL8 eta, REAL8 chi1, REAL8 chi2, REAL8 omega, REAL8 e, REAL8 sz, REAL8 cz)
{
    REAL8 eta2, dm;
    eta2 = eta * eta;
    dm = sqrt(1. - 4. * eta);
    ...
    L3_4 = cbrtTerm *
           (36 * (chi22 + (chi1 - chi2) * (chi1 + chi2) * dm) + 9 * (45 + 4 * chi12 - 15 * eta) -
            72 * chi1Mchi2Sq * eta + 5 * e4 * (9 + (-3 + eta) * eta) + 5 * eta2 +
            2 * e2 *
                (143 - 21 * chi22 * (-1 + dm) + 21 * chi12 * (1 + dm) -
                 3 * (7 - 8 * chi1 * chi2 + 2 * chi22 * (12 - 5 * dm) + 2 * chi12 * (12 + 5 * dm)) * eta +
                 5 * (-1 + 6 * chi1Pchi2Sq) * eta2) +
            2 * e *
                (cz2 * e *
                     (-16 + 3 * chi12 * (-1 - dm + 2 * (2 + dm - eta) * eta) +
                      3 * chi22 * (-1 + dm - 2 * eta * (-2 + dm + eta)) - 12 * chi1 * chi2 * eta2) -
                 4 * cz *
                     (21 - 3 * chi22 * (-1 + dm) + 3 * chi12 * (1 + dm) - eta + 6 * chi22 * (-2 + dm) * eta -
                      6 * chi12 * (2 + dm) * eta + e2 * (3 + eta) + 6 * chi1Pchi2Sq * eta2))) /
           24.;
    return cbrt(L3_0 + L3_2 + L3_3 + L3_4);
}

REAL8
calculate_rDot_from_pr(REAL8 eta, REAL8 chi1, REAL8 chi2, REAL8 r, REAL8 prT, REAL8 pf)
{
    ...
    pr_4 =
        (prT * (3 * (1 + eta + eta2) * pf4 + 2 * pf2 * r * (2 + 2 * eta - 6 * eta2 + 3 * (1 + eta + eta2) * prT2 * r) +
                r2 * (4 * (-1 - chi22 * (-1 + dm) + chi12 * (1 + dm) +
                           (5 + 2 * chi22 * (-2 + dm) - 2 * chi12 * (2 + dm)) * eta + (3 + 2 * chi1Pluschi2Sq) * eta2) -
                      4 * (1 + eta + 3 * eta2) * prT2 * r + 3 * (1 + eta + eta2) * prT4 * r2))) /
        (8. * r4);
    // non-tortoise
    // pr_0 = prT;
    // pr_2 = -0.5*(prT*((1 + eta)*pf2 + r*(6 - 2*eta + (1 + eta)*prT2*r)))/r2;
    // pr_4 = (prT*(3*(1 + eta + eta2)*pf4 + 6*pf2*r*
    //     (2 - 2*(-1 + eta)*eta + (1 + eta + eta2)*prT2*r) +
    //     r2*(4*(3 - chi22*(-1 + dm) + chi12*(1 + dm) +
    //     (7 + 2*chi22*(-2 + dm) - 2*chi12*(2 + dm))*eta +
    //     (3 + 2*chi1Pluschi2Sq)*eta2) + 4*(5 + (5 - 3*eta)*eta)*prT2*r +
    //     3*(1 + eta + eta2)*prT4*r2)))/(8.*r4);
    return pr_0 + pr_2 + pr_4;
}
REAL8
calculate_rDot_from_prPrec(REAL8 eta, REAL8 c1n, REAL8 c2n, REAL8 c1c1, REAL8 c1c2, REAL8 c2c2, REAL8 r, REAL8 prT,
                           REAL8 L)
{
    REAL8 eta2;
    eta2 = eta * eta;
    ...
    REAL8 pr_0, pr_2, pr_4;
    pr_0 = prT;
    pr_2 = -0.5 * (prT * ((1 + eta) * L2 + r * (2 - 2 * eta + (1 + eta) * prT2 * r))) / r2;
    pr_4 =
        (prT *
         (3 * (1 + eta + eta2) * L4 + 2 * L2 * r * (2 + 2 * eta - 6 * eta2 + 3 * (1 + eta + eta2) * prT2 * r) +
          r2 * (4 * c1c1 * dm - 4 * c1n2 * dm - 4 * c2c2 * dm + 4 * c2n2 * dm - 8 * c1c1 * dm * eta +
                8 * c1c2 * dm * eta + 8 * c1n2 * dm * eta + 8 * c2c2 * dm * eta - 8 * c2n2 * dm * eta +
                4 * (-1 + c1c1 - c1n2 + c2c2 - c2n2 + (5 - 4 * c1c1 + 2 * c1c2 + 4 * c1n2 - 4 * c2c2 + 4 * c2n2) * eta +
                     (3 + 2 * c1c1 + 2 * c2c2 - 2 * pow(c1n + c2n, 2)) * eta2) -
                4 * (1 + eta + 3 * eta2) * prT2 * r + 3 * (1 + eta + eta2) * prT4 * r2))) /
        (8. * r4);
    // non-tortoise
    // pr_0 = prT;
    // pr_2 = -0.5*(prT*((1 + eta)*L2 + r*(6 - 2*eta + (1 + eta)*prT2*r)))/r2;
    // pr_4 = (prT*(3*(1 + eta + eta2)*L4 + 6*L2*r*(2 - 2*(-1 + eta)*eta + (1 +
    // eta + eta2)*prT2*r) +
    //     r2*(4*c1c1*dm - 4*c1n2*dm - 4*c2c2*dm + 4*c2n2*dm - 8*c1c1*dm*eta +
    //     8*c1c2*dm*eta + 8*c1n2*dm*eta + 8*c2c2*dm*eta - 8*c2n2*dm*eta +
    //     4*(3 + c1c1 - c1n2 + c2c2 - c2n2 +
    //     (7 - 4*c1c1 + 2*c1c2 + 4*c1n2 - 4*c2c2 + 4*c2n2)*eta +
    //     (3 + 2*c1c1 + 2*c2c2 - 2*pow(c1n + c2n,2))*eta2) +
    //     4*(5 + (5 - 3*eta)*eta)*prT2*r + 3*(1 + eta +
    //     eta2)*prT4*r2)))/(8.*r4);
    return pr_0 + pr_2 + pr_4;
}

void calculate_prDot_from_ezetapphi(REAL8 eta, REAL8 chi1, REAL8 chi2, REAL8 e, REAL8 sz, REAL8 cz, REAL8 pf, REAL8 Omg,
                                    REAL8 *ret_prT, REAL8 *ret_prDot, REAL8 *ret_r, REAL8 *ret_rDot, REAL8 *ret_L)
{
    ...
    // prDot3 = -0.25*(e*(-((1 + 3*cz2)*e) + 6*cz*(1 + e2))*(chi1*(2 + 2*dm -
    // eta)
    // - chi2*(-2 + 2*dm + eta)))/pf7; prDot4 = (e*(e*(3*cz3*e*(-2*eta*(2 +
    // chi12sq*eta) + chi22*(-1 + dm + 4*eta - 2*dm*eta) +
    //     chi12*(-1 + 4*eta + dm*(-1 + 2*eta))) +
    //     2*cz2*(-41 - 7*e2 - 7*eta - 6*chi1*chi2*eta + e2*eta +
    //     chi22*(-7 + 7*dm + 25*eta - 11*dm*eta) +
    //     chi12*(-7 + 25*eta + dm*(-7 + 11*eta)) - 11*chi12sq*eta2) +
    //     2*(-59 - 21*e2 + 11*eta - 2*chi1*chi2*eta + 3*e2*eta +
    //     chi12*(-1 + dm*(-1 + eta) + 3*eta) + chi22*(-1 + dm + 3*eta - dm*eta)
    //     - chi12sq*eta2)) + cz*(95 +
    //     (-1 + 24*chi1*chi2 - 12*chi22*(-1 + dm) + 12*chi12*(1 + dm))*eta -
    //     3*(-1 + 4*chi12 + 8*chi1*chi2 + 4*chi22)*eta2 + e4*(55 - 17*eta +
    //     3*eta2) + e2*(4*chi1*chi2*eta*(6 + 13*eta) - 6*(-39 + 3*eta + eta2) +
    //     chi12*(19 + dm*(19 - 26*eta) - 64*eta + 26*eta2) +
    //     chi22*(19 - 19*dm - 64*eta + 26*dm*eta + 26*eta2)))))/(8.*pf8);
    prDot0 = (cz * e) / pf4;
    prDot2 = -0.5 * (e * ((3 + cz2) * e + cz * (-7 + e2 * (-5 + eta) - eta))) / pf6;
    prDot3 = -0.25 *
             (e * (-((1 + 3 * cz2) * e) + 6 * cz * (1 + e2)) *
              (2 * (chi1 + chi2) + 2 * chi1 * dm - 2 * chi2 * dm - (chi1 + chi2) * eta)) /
             pf7;
    prDot4 =
        (e *
         (e * (2 * cz2 *
                   (-41 + 7 * chi22 * (-1 + dm) - 7 * chi12 * (1 + dm) + e2 * (-7 + eta) +
                    (-7 - 6 * chi1 * chi2 + chi22 * (25 - 11 * dm) + chi12 * (25 + 11 * dm)) * eta -
                    11 * chi12sq * eta2) +
               2 * (-59 + chi22 * (-1 + dm) - chi12 * (1 + dm) + 3 * e2 * (-7 + eta) +
                    (11 - 2 * chi1 * chi2 - chi22 * (-3 + dm) + chi12 * (3 + dm)) * eta - chi12sq * eta2) -
               3 * cz3 * e *
                   (-(chi22 * (-1 + dm)) + chi12 * (1 + dm) + 4 * eta + 2 * chi22 * (-2 + dm) * eta -
                    2 * chi12 * (2 + dm) * eta + 2 * chi12sq * eta2)) +
          cz * (95 +
                eta * (-1 + 12 * (chi1 + chi2) * (chi1 + chi2 + chi1 * dm - chi2 * dm) - 3 * (-1 + 4 * chi12sq) * eta) +
                e4 * (55 + eta * (-17 + 3 * eta)) +
    ...
    rDot4 = (e * (-81 - 2 * chi12 - 2 * chi22 - 2 * chi12 * dm + 2 * chi22 * dm + 28 * e2 + 6 * chi12 * e2 +
                  ...
                  8 * chi22 * eta + 4 * chi12 * dm * eta - 4 * chi22 * dm * eta + 10 * e2 * eta -
                  20 * chi12 * e2 * eta + 8 * chi1 * chi2 * e2 * eta - 20 * chi22 * e2 * eta -
                  8 * chi12 * dm * e2 * eta + 8 * chi22 * dm * e2 * eta - 9 * e4 * eta + 6 * cz2 * e2 * (1 + 2 * eta) +
                  3 * eta2 - 4 * chi12 * eta2 - 8 * chi1 * chi2 * eta2 - 4 * chi22 * eta2 - 6 * e2 * eta2 +
                  8 * chi12 * e2 * eta2 + 16 * chi1 * chi2 * e2 * eta2 + 8 * chi22 * e2 * eta2 + 3 * e4 * eta2 +
                  4 * cz * e *
                      (-29 - chi12 - chi22 - chi12 * dm + chi22 * dm + 3 * e2 * (-3 + eta) +
                       (11 - 2 * chi1 * chi2 - chi22 * (-3 + dm) + chi12 * (3 + dm)) * eta - chi12sq * eta2))) /
            (8. * pf5);
    ...
    // pr0 = e/pf;
    // pr2 = ((-cz + e)*e2)/pf3;
    // pr3 = -0.5*((-cz + e)*e2*(chi1*(2 + 2*dm - eta) - chi2*(-2 + 2*dm +
    // eta)))/pf4; pr4 = (e*(-18 - 3*chi12 - 3*chi22 - 3*chi12*dm + 3*chi22*dm +
    // 23*e2 + 2*chi12*e2 +
    //     2*chi22*e2 + 2*chi12*dm*e2 - 2*chi22*dm*e2 + 8*e4 + 12*chi12*eta +
    //     12*chi22*eta + 6*chi12*dm*eta - 6*chi22*dm*eta - 4*e2*eta -
    //     6*chi12*e2*eta + 4*chi1*chi2*e2*eta - 6*chi22*e2*eta -
    //     2*chi12*dm*e2*eta + 2*chi22*dm*e2*eta - 6*chi12*eta2 -
    //     12*chi1*chi2*eta2 - 6*chi22*eta2 + 2*chi12*e2*eta2 +
    //     4*chi1*chi2*e2*eta2 + 2*chi22*e2*eta2 +
    //     cz2*e2*(-1 + chi22*(-1 + dm + 4*eta - 2*dm*eta - 2*eta2) -
    //     4*chi1*chi2*eta2 - chi12*(1 + dm - 4*eta - 2*dm*eta + 2*eta2)) -
    //     2*cz*e*(18 + 4*e2 - 2*eta + 2*chi1*chi2*eta*(1 + 5*eta) +
    //     chi12*(3 + dm*(3 - 5*eta) - 11*eta + 5*eta2) +
    //     chi22*(3 - 3*dm - 11*eta + 5*dm*eta + 5*eta2))))/(4.*pf5);
    // pr0 = e2/pf2;
    // pr2 = (2*(-cz + e)*e3)/pf4;
    // pr3 = -(((-cz + e)*e3*(chi1*(2 + 2*dm - eta) - chi2*(-2 + 2*dm +
    // eta)))/pf5); pr4 = (e2*(-18 - 3*chi12 - 3*chi22 - 3*chi12*dm + 3*chi22*dm
    // + 24*e2 + 2*chi12*e2 +
    //     2*chi22*e2 + 2*chi12*dm*e2 - 2*chi22*dm*e2 + 10*e4 + 12*chi12*eta +
    //     12*chi22*eta + 6*chi12*dm*eta - 6*chi22*dm*eta - 4*e2*eta -
    //     6*chi12*e2*eta + 4*chi1*chi2*e2*eta - 6*chi22*e2*eta -
    //     2*chi12*dm*e2*eta + 2*chi22*dm*e2*eta - 6*chi12*eta2 -
    //     12*chi1*chi2*eta2 - 6*chi22*eta2 + 2*chi12*e2*eta2 +
    //     4*chi1*chi2*e2*eta2 + 2*chi22*e2*eta2 -
    //     2*cz*e*(18 + 6*e2 + chi12*(3 + dm*(3 - 5*eta) - 11*eta) - 2*eta +
    //     2*chi1*chi2*eta + chi22*(3 - 3*dm - 11*eta + 5*dm*eta) +
    //     5*chi12sq*eta2) + cz2*e2*(chi22*(-1 + dm + 4*eta - 2*dm*eta - 2*eta2)
    //     - 4*chi1*chi2*eta2 - chi12*(1 + dm - 4*eta - 2*dm*eta +
    //     2*eta2))))/(2.*pf6);
    // non-tortoise
    pr0 = e / pf;
    pr2 = (e * (2 + cz * e + e2)) / pf3;
    pr3 = -0.5 * ((-cz + e) * e2 * (2 * (chi1 + chi2) + 2 * chi1 * dm - 2 * chi2 * dm - (chi1 + chi2) * eta)) / pf4;
    pr4 = (e * (22 + 3 * chi22 * (-1 + dm) - 3 * chi12 * (1 + dm) + 8 * e4 +
                6 * (-2 - chi22 * (-2 + dm) + chi12 * (2 + dm)) * eta - 6 * chi12sq * eta2 +
                e2 * (43 - 2 * chi22 * (-1 + dm) + 2 * chi12 * (1 + dm) -
                      2 * (5 - 2 * chi1 * chi2 - chi22 * (-3 + dm) + chi12 * (3 + dm)) * eta + 2 * chi12sq * eta2) +
                e * (2 * cz *
                         (6 + 3 * chi22 * (-1 + dm) - 3 * chi12 * (1 + dm) + 4 * e2 +
                          (-10 - 2 * chi1 * chi2 + chi22 * (11 - 5 * dm) + chi12 * (11 + 5 * dm)) * eta -
                          5 * chi12sq * eta2) -
                     cz2 * e *
                         (-3 - chi22 * (-1 + dm) + chi12 * (1 + dm) + 6 * eta + 2 * chi22 * (-2 + dm) * eta -
                          2 * chi12 * (2 + dm) * eta + 2 * chi12sq * eta2)))) /
          (4. * pf5);
    REAL8 r0, r2, r3, r4;
    r0 = pf2;
    ...
    r4 = -0.5 *
         (2 * e4 + 2 * (9 + chi12 - 3 * eta) + 2 * chi1 * chi2 * eta * (3 + eta) +
          chi22 * (2 - 2 * dm + eta * (-5 + dm + eta)) + chi12 * (2 * dm - (5 + dm) * eta + eta2) +
          e2 * (2 * (6 + chi22 - chi22 * dm + chi12 * (1 + dm)) -
                (2 - 2 * chi1 * chi2 + chi22 * (7 - 3 * dm) + chi12 * (7 + 3 * dm)) * eta + 3 * chi12sq * eta2)) /
         pf2;
    ...
    L3_4 = (36 * (chi22 + (chi1 - chi2) * (chi1 + chi2) * dm) + 9 * (45 + 4 * chi12 - 15 * eta) -
            ...
            2 * e *
                (cz2 * e *
                 ...
                 4 * cz *
                     (21 - 3 * chi22 * (-1 + dm) + 3 * chi12 * (1 + dm) - eta + 6 * chi22 * (-2 + dm) * eta -
                      6 * chi12 * (2 + dm) * eta + e2 * (3 + eta) + 6 * chi12sq * eta2))) /
           (24. * cbL3_0);
...
void calculate_prDot_from_ezetapphiPrec(REAL8 eta, REAL8 c1n, REAL8 c1l, REAL8 c1e, REAL8 c2n, REAL8 c2l, REAL8 c2e,
                                        REAL8 c1c1, REAL8 c1c2, REAL8 c2c2, REAL8 e, REAL8 sz, REAL8 cz, REAL8 pl,
                                        REAL8 pe, REAL8 L, REAL8 Omg, REAL8 *ret_prT, REAL8 *ret_prDot, REAL8 *ret_rDot,
                                        REAL8 *ret_r, REAL8 *ret_L)
{
    ...
    c2e2 = c2e * c2e;
    REAL8 c1nPc2nsq;
    c1nPc2nsq = (c1n + c2n) * (c1n + c2n);
    // calculate prT
    REAL8 pr0, pr2, pr3, pr4;
    // tortoise
    // pr0 = e/L;
    // pr2 = ((-cz + e)*e2)/L3;
    // pr3 = (e*(2*c1l*dm*pe - 2*c2l*dm*pe - 2*c1e*dm*pl + 2*c2e*dm*pl - (-2 +
    // eta)*((c1l + c2l)*pe - (c1e + c2e)*pl)))/(2.*L3); pr4 = (e*(2*c1n2*dm +
    // 6*c2c2*dm - 2*c2n2*dm - 3*c1n2*dm*e2 - 4*c2c2*dm*e2 + 3*c2n2*dm*e2 +
    //     e2*(-3*c1n2 + 4*c2c2 - 3*c2n2 + 16*e2) - 4*c1n2*dm*eta -
    //     12*c2c2*dm*eta
    //     + 4*c2n2*dm*eta - 6*c1n2*dm*e2*eta + 4*c2c2*dm*e2*eta +
    //     6*c2n2*dm*e2*eta + 4*c1c2*(1 + dm)*(-3*eta + e2*(1 + eta)) +
    //     2*c1c1*(-3*(1 + dm) + 6*(2 + dm - eta)*eta +
    //     2*e2*(1 + dm - (3 + dm)*eta + eta2)) +
    //     e*(4*cz*(2*c1n2 - 3*c2c2 + 2*c1n2*dm + 3*c2c2*dm - 2*c2n2*dm +
    //     (-5*c1n2 + 11*c2c2 + 6*c1n*c2n - 5*c2n2)*eta - c1n2*dm*eta -
    //     5*c2c2*dm*eta + c2n2*dm*eta + 2*(-9 + c2n2 - 2*e2 + eta) -
    //     c1c2*(1 + dm)*(1 + 5*eta) +
    //     c1c1*(-3*(1 + dm) + (11 + 5*dm - 5*eta)*eta) +
    //     (-5*c2c2 + c1nPc2nsq)*eta2) +
    //     cz2*e*(-2 + c1n2 - 2*c2c2 + c2n2 + c1n2*dm + 2*c2c2*dm - c2n2*dm -
    //     4*(c1c2 + c1n2 - 2*c2c2 + c2n2)*eta - 4*c1c2*dm*eta - 2*c1n2*dm*eta -
    //     4*c2c2*dm*eta + 2*c2n2*dm*eta +
    //     c1c1*(-2*(1 + dm) + 4*(2 + dm - eta)*eta) +
    //     2*(-2*c2c2 + c1nPc2nsq)*eta2)) - 2*c1e2*dm*L2*pe2 +
    //     2*c2e2*dm*L2*pe2 + 4*c1e2*dm*eta*L2*pe2 - 4*c2e2*dm*eta*L2*pe2 -
    //     4*c1e*c1l*dm*L2*pe*pl + 4*c2e*c2l*dm*L2*pe*pl +
    //     8*c1e*c1l*dm*eta*L2*pe*pl - 8*c2e*c2l*dm*eta*L2*pe*pl - 2*eta2*(6*c2c2
    //     - 2*c1nPc2nsq - (2*c2c2 + 3*c1nPc2nsq)*e2 + 2*pow((c1e + c2e)*L*pe +
    //     (c1l + c2l)*L*pl,2)) - 2*c1l2*dm*L2*pl2 + 2*c2l2*dm*L2*pl2 +
    //     4*c1l2*dm*eta*L2*pl2 - 4*c2l2*dm*eta*L2*pl2 + 2*(-18 + c1n2 - 3*c2c2 +
    //     c2n2 + 23*e2 - L2*((c1e2 + c2e2)*pe2 + 2*(c1e*c1l + c2e*c2l)*pe*pl +
    //     (c1l2 + c2l2)*pl2)) + 4*eta*(-2*c2n2 - 3*c2c2*(-2 + e2) - 2*e2 -
    //     2*c1n*(c1n + 3*c2n*e2) + 2*L2*((c1e2 + c2e2)*pe2 + 2*(c1e*c1l +
    //     c2e*c2l)*pe*pl + (c1l2 + c2l2)*pl2)))
    //     )/(8.*L5);
    // non-tortoise
    pr0 = e / L;
    pr2 = (e * (2 + cz * e + e2)) / L3;
    pr3 = (e * (2 * c1l * dm * pe - 2 * c2l * dm * pe - 2 * c1e * dm * pl + 2 * c2e * dm * pl -
                (-2 + eta) * ((c1l + c2l) * pe - (c1e + c2e) * pl))) /
          (2. * L3);
    pr4 = (e * (2 * c1n2 * dm + 6 * c2c2 * dm - 2 * c2n2 * dm - 3 * c1n2 * dm * e2 - 4 * c2c2 * dm * e2 +
                3 * c2n2 * dm * e2 + e2 * (-3 * c1n2 + 4 * c2c2 - 3 * c2n2 + 16 * e2) - 4 * c1n2 * dm * eta -
                12 * c2c2 * dm * eta + 4 * c2n2 * dm * eta - 6 * c1n2 * dm * e2 * eta + 4 * c2c2 * dm * e2 * eta +
                6 * c2n2 * dm * e2 * eta + 4 * c1c2 * (1 + dm) * (-3 * eta + e2 * (1 + eta)) +
                2 * c1c1 * (-3 * (1 + dm) + 6 * (2 + dm - eta) * eta + 2 * e2 * (1 + dm - (3 + dm) * eta + eta2)) +
                e * (cz2 * e *
                         (6 + c2n2 + 2 * c2c2 * dm - c2n2 * dm - 4 * (3 + c1c2) * eta - 4 * c1c2 * dm * eta -
                          4 * c2c2 * dm * eta + 2 * c2n2 * dm * eta + 2 * c2n2 * (-2 + eta) * eta +
                          c1c1 * (-2 * (1 + dm) + 4 * (2 + dm - eta) * eta) - 2 * c2c2 * (1 + 2 * (-2 + eta) * eta) +
                          c1n2 * (1 + dm + 2 * eta * (-2 - dm + eta)) + 4 * c1n * c2n * eta2) +
                     4 * cz *
                         (6 + 2 * c1n2 - 3 * c2c2 + 2 * c2n2 + 2 * c1n2 * dm + 3 * c2c2 * dm - 2 * c2n2 * dm + 4 * e2 -
                          10 * eta + (-5 * c1n2 + 11 * c2c2 + 6 * c1n * c2n - 5 * c2n2) * eta - c1n2 * dm * eta -
                          5 * c2c2 * dm * eta + c2n2 * dm * eta - c1c2 * (1 + dm) * (1 + 5 * eta) +
                          c1c1 * (-3 * (1 + dm) + (11 + 5 * dm - 5 * eta) * eta) + (-5 * c2c2 + c1nPc2nsq) * eta2)) -
                2 * c1e2 * dm * L2 * pe2 + 2 * c2e2 * dm * L2 * pe2 + 4 * c1e2 * dm * eta * L2 * pe2 -
                4 * c2e2 * dm * eta * L2 * pe2 - 4 * c1e * c1l * dm * L2 * pe * pl + 4 * c2e * c2l * dm * L2 * pe * pl +
                8 * c1e * c1l * dm * eta * L2 * pe * pl - 8 * c2e * c2l * dm * eta * L2 * pe * pl -
                2 * eta2 *
                    (6 * c2c2 - 2 * c1nPc2nsq - (2 * c2c2 + 3 * c1nPc2nsq) * e2 +
                     2 * pow((c1e + c2e) * L * pe + (c1l + c2l) * L * pl, 2)) -
                2 * c1l2 * dm * L2 * pl2 + 2 * c2l2 * dm * L2 * pl2 + 4 * c1l2 * dm * eta * L2 * pl2 -
                4 * c2l2 * dm * eta * L2 * pl2 +
                2 * (22 + c1n2 - 3 * c2c2 + c2n2 + 43 * e2 - 12 * eta -
                     L2 * ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2)) +
                4 * eta *
                    (-2 * c2n2 - 3 * c2c2 * (-2 + e2) - 5 * e2 - 2 * c1n * (c1n + 3 * c2n * e2) +
    ...
    // prDot3 = ((-1 + 3*cz*e)*(2*c1l*dm*pe - 2*c2l*dm*pe - (c1l + c2l)*(-2 +
    // eta)*pe - 2*c1e*dm*pl +
    ...
    //     e2*(cz3*e*(3*c2c2*dm - c2n2*dm - 6*c1c2*dm*eta - 6*c2c2*dm*eta +
    //     2*c2n2*dm*eta + 3*c1c1*(-1 - dm + 2*(2 + dm - eta)*eta) + c2n2*(1 +
    //     2*(-2 + eta)*eta) - 3*(c2c2 + 2*(2 + c1c2)*eta + 2*c2c2*(-2 +
    //     eta)*eta)
    //     + c1n2*(1 + dm + 2*eta*(-2 - dm + eta)) + 4*c1n*c2n*eta2) + 2*cz2*(-41
    //     + 4*c1n2 - 7*c2c2 + 4*c2n2 + 4*c1n2*dm + 7*c2c2*dm - 4*c2n2*dm - 7*e2
    //     - 7*eta + c1n2*dm*eta - 11*c2c2*dm*eta - c2n2*dm*eta +
    ...
    //     8*c1e*c1l*dm*L2*pe*pl + 8*c2e*c2l*dm*L2*pe*pl +
    //     16*c1e*c1l*dm*eta*L2*pe*pl - 16*c2e*c2l*dm*eta*L2*pe*pl + eta2*(3 -
    //     12*c1c1 - 12*c2c2 + 12*c2n2 - 6*e2 + 2*(13*(c1c1 + c2c2) + 5*c2n2)*e2
    //     + 3*e4 - 8*pow((c1e + c2e)*L*pe + (c1l + c2l)*L*pl,2)) -
    //     4*c1l2*dm*L2*pl2
    //     + 4*c2l2*dm*L2*pl2 + 8*c1l2*dm*eta*L2*pl2 - 8*c2l2*dm*eta*L2*pl2 -
    //     4*L2*((c1e2 + c2e2)*pe2 + 2*(c1e*c1l + c2e*c2l)*pe*pl + (c1l2 +
    //     c2l2)*pl2) + eta*(12*c1c1 + 16*(-4*(c1c1 + c2c2) + c2n2)*e2 - 17*e4 +
    ...
    prDot0 = (cz * e) / L4;
    prDot2 = -0.5 * (e * ((3 + cz2) * e + cz * (-7 + e2 * (-5 + eta) - eta))) / L6;
    prDot3 = ((-1 + 3 * cz * e) * (2 * c1l * dm * pe - 2 * c2l * dm * pe - (c1l + c2l) * (-2 + eta) * pe -
                                   2 * c1e * dm * pl + 2 * c2e * dm * pl + (c1e + c2e) * (-2 + eta) * pl)) /
             (2. * L6);
    prDot4 =
        (6 * e4 * (-7 + eta) +
         2 * e2 *
             (-59 - c2c2 + c2c2 * dm + 11 * eta + 3 * (c2c2 + c1nPc2nsq) * eta + 3 * c1n2 * dm * eta - c2c2 * dm * eta -
              3 * c2n2 * dm * eta - c1c2 * (1 + dm) * (1 + eta) + c1c1 * (-1 - dm + (3 + dm - eta) * eta) -
              (c2c2 + 3 * c1nPc2nsq) * eta2) +
         e2 * (cz3 * e *
                   (3 * c2c2 * dm - c2n2 * dm - 6 * c1c2 * dm * eta - 6 * c2c2 * dm * eta + 2 * c2n2 * dm * eta +
                    3 * c1c1 * (-1 - dm + 2 * (2 + dm - eta) * eta) + c2n2 * (1 + 2 * (-2 + eta) * eta) -
                    3 * (c2c2 + 2 * (2 + c1c2) * eta + 2 * c2c2 * (-2 + eta) * eta) +
                    c1n2 * (1 + dm + 2 * eta * (-2 - dm + eta)) + 4 * c1n * c2n * eta2) +
               2 * cz2 *
                   (-41 + 4 * c1n2 - 7 * c2c2 + 4 * c2n2 + 4 * c1n2 * dm + 7 * c2c2 * dm - 4 * c2n2 * dm - 7 * e2 -
                    7 * eta + c1n2 * dm * eta - 11 * c2c2 * dm * eta - c2n2 * dm * eta +
                    (-7 * c1n2 + 25 * c2c2 + 18 * c1n * c2n - 7 * c2n2 + e2) * eta - c1c2 * (1 + dm) * (3 + 11 * eta) +
                    c1c1 * (-7 * (1 + dm) + (25 + 11 * dm - 11 * eta) * eta) - (11 * c2c2 + c1nPc2nsq) * eta2)) +
         4 * L2 *
             (c1e2 * (1 + dm + 2 * eta * (-2 - dm + eta)) * pe2 + c2e2 * (1 - dm + 2 * eta * (-2 + dm + eta)) * pe2 +
              2 * c2e * (c2l - c2l * dm + 2 * c2l * eta * (-2 + dm + eta) + 2 * c1l * eta2) * pe * pl +
              2 * c1e * pe * (c1l * (1 + dm + 2 * eta * (-2 - dm + eta)) * pl + 2 * eta2 * (c2e * pe + c2l * pl)) +
              (c1l2 * (1 + dm + 2 * eta * (-2 - dm + eta)) + c2l2 * (1 - dm + 2 * eta * (-2 + dm + eta)) +
               4 * c1l * c2l * eta2) *
                  pl2) +
         cz * e *
             (95 - 12 * c2n2 + 12 * c2n2 * dm + (234 + 19 * c1c1) * e2 + 19 * c1c1 * dm * e2 - 19 * c2c2 * dm * e2 +
              13 * c2n2 * dm * e2 + e2 * (19 * c2c2 - 13 * c2n2 + 55 * e2) - eta + 12 * c1c1 * dm * eta -
              12 * c2c2 * dm * eta + 12 * c2n2 * dm * eta - 26 * c1c1 * dm * e2 * eta + 26 * c2c2 * dm * e2 * eta +
              10 * c2n2 * dm * e2 * eta + 4 * c1n * c2n * eta * (6 * (-3 + eta) + e2 * (-18 + 5 * eta)) +
              2 * c1c2 * (1 + dm) * (6 - 6 * eta + e2 * (6 + 13 * eta)) -
              c1n2 * (12 * (1 + dm + (-1 + dm - eta) * eta) + e2 * (13 * (1 + dm) - 2 * eta * (8 - 5 * dm + 5 * eta))) -
              4 * c1e2 * dm * L2 * pe2 + 4 * c2e2 * dm * L2 * pe2 + 8 * c1e2 * dm * eta * L2 * pe2 -
              8 * c2e2 * dm * eta * L2 * pe2 - 8 * c1e * c1l * dm * L2 * pe * pl + 8 * c2e * c2l * dm * L2 * pe * pl +
              16 * c1e * c1l * dm * eta * L2 * pe * pl - 16 * c2e * c2l * dm * eta * L2 * pe * pl +
              eta2 * (3 - 12 * c1c1 - 12 * c2c2 + 12 * c2n2 - 6 * e2 + 2 * (13 * (c1c1 + c2c2) + 5 * c2n2) * e2 +
                      3 * e4 - 8 * pow((c1e + c2e) * L * pe + (c1l + c2l) * L * pl, 2)) -
              4 * c1l2 * dm * L2 * pl2 + 4 * c2l2 * dm * L2 * pl2 + 8 * c1l2 * dm * eta * L2 * pl2 -
              8 * c2l2 * dm * eta * L2 * pl2 -
              4 * L2 * ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2) +
              eta * (12 * c1c1 + 16 * (-4 * (c1c1 + c2c2) + c2n2) * e2 - 17 * e4 +
                     2 * (6 * c2c2 + 6 * c2n2 - 9 * e2 +
                          8 * L2 *
                              ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2))))) /
        (8. * L8);
    // actually this is rDot
    REAL8 rDot0, rDot2, rDot3, rDot4;
    rDot0 = e / L;
    rDot2 = (e * (-3 - 6 * cz * e - e2 * (-1 + eta) + eta)) / (2. * L3);
    rDot3 = (e * (2 * c1l * dm * pe - 2 * c2l * dm * pe - (c1l + c2l) * (-2 + eta) * pe - 2 * c1e * dm * pl +
                  2 * c2e * dm * pl + (c1e + c2e) * (-2 + eta) * pl)) /
            (2. * L3);
    rDot4 =
        (e *
         (-2 * c1n2 - 2 * c2c2 - 2 * c2n2 - 2 * c1n2 * dm + 2 * c2c2 * dm + 2 * c2n2 * dm + 28 * e2 -
          ...
          2 * c1c1 * (1 + dm + 2 * eta * (-2 - dm + eta) + e2 * (-3 * (1 + dm) + 2 * (5 + 2 * dm - 2 * eta) * eta)) +
          e * (cz2 * e *
                   (6 + 12 * eta + c1n2 * (-1 - dm + 2 * (2 + dm - eta) * eta) +
                    c2n2 * (-1 + dm - 2 * eta * (-2 + dm + eta)) - 4 * c1n * c2n * eta2) +
               4 * cz *
                   (-29 - c2c2 + c2c2 * dm - 9 * e2 + 11 * eta + 3 * c1n2 * dm * eta - c2c2 * dm * eta -
                    3 * c2n2 * dm * eta + 3 * (c2c2 + c1nPc2nsq + e2) * eta - c1c2 * (1 + dm) * (1 + eta) +
                    c1c1 * (-1 - dm + (3 + dm - eta) * eta) - (c2c2 + 3 * c1nPc2nsq) * eta2)) -
          2 * c1e2 * dm * L2 * pe2 + 2 * c2e2 * dm * L2 * pe2 + 4 * c1e2 * dm * eta * L2 * pe2 -
          4 * c2e2 * dm * eta * L2 * pe2 - 4 * c1e * c1l * dm * L2 * pe * pl + 4 * c2e * c2l * dm * L2 * pe * pl +
          8 * c1e * c1l * dm * eta * L2 * pe * pl - 8 * c2e * c2l * dm * eta * L2 * pe * pl +
          eta2 * (3 - 4 * c2c2 - 4 * c1nPc2nsq - 6 * e2 + 2 * (4 * c2c2 + c1nPc2nsq) * e2 + 3 * e4 -
                  4 * pow((c1e + c2e) * L * pe + (c1l + c2l) * L * pl, 2)) -
          2 * c1l2 * dm * L2 * pl2 + 2 * c2l2 * dm * L2 * pl2 + 4 * c1l2 * dm * eta * L2 * pl2 -
          4 * c2l2 * dm * eta * L2 * pl2 +
          2 * L2 * (-((c1e2 + c2e2) * pe2) - 2 * (c1e * c1l + c2e * c2l) * pe * pl - (c1l2 + c2l2) * pl2) +
          eta * (8 * c1n2 + 8 * c2c2 + 8 * c2n2 + 10 * e2 + 4 * (-5 * c2c2 + 2 * (c1n2 - 3 * c1n * c2n + c2n2)) * e2 -
                 9 * e4 +
                 8 * L2 * ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2)))) /
        (8. * L5);
    REAL8 r_0, r_2, r_3, r_4;
    r_0 = L2;
    r_2 = -3 - e2;
    r_3 = -2 * c1l * dm * pe + 2 * c2l * dm * pe + (c1l + c2l) * (-2 + eta) * pe + 2 * c1e * dm * pl -
          2 * c2e * dm * pl - (c1e + c2e) * (-2 + eta) * pl;
    r_4 =
        (3 * c1n2 - 2 * c2c2 + 3 * c2n2 + 3 * c1n2 * dm + 2 * c2c2 * dm - 3 * c2n2 * dm - 12 * e2 + c1n2 * dm * e2 +
         2 * c2c2 * dm * e2 - c2n2 * dm * e2 + (c1n2 - 2 * c2c2 + c2n2 - 2 * e2) * e2 + 6 * (-3 + eta) +
         3 * c1n2 * dm * eta - c2c2 * dm * eta - 3 * c2n2 * dm * eta + c1n2 * dm * e2 * eta - 3 * c2c2 * dm * e2 * eta -
         c2n2 * dm * e2 * eta - c1c2 * (1 + dm) * (3 + eta + e2 * (1 + 3 * eta)) +
         c1c1 * (-2 * (1 + dm) + (5 + dm - eta) * eta + e2 * (-2 * (1 + dm) + (7 + 3 * dm - 3 * eta) * eta)) +
         c1e2 * dm * L2 * pe2 - c2e2 * dm * L2 * pe2 - 2 * c1e2 * dm * eta * L2 * pe2 + 2 * c2e2 * dm * eta * L2 * pe2 +
         2 * c1e * c1l * dm * L2 * pe * pl - 2 * c2e * c2l * dm * L2 * pe * pl -
         4 * c1e * c1l * dm * eta * L2 * pe * pl + 4 * c2e * c2l * dm * eta * L2 * pe * pl -
         eta2 * (c2c2 + 3 * c1nPc2nsq + (3 * c2c2 + c1nPc2nsq) * e2 -
                 2 * pow((c1e + c2e) * L * pe + (c1l + c2l) * L * pl, 2)) +
         c1l2 * dm * L2 * pl2 - c2l2 * dm * L2 * pl2 - 2 * c1l2 * dm * eta * L2 * pl2 + 2 * c2l2 * dm * eta * L2 * pl2 +
         L2 * ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2) -
         eta * (-5 * c2c2 + 3 * (c1n2 - 6 * c1n * c2n + c2n2) - 2 * e2 + (c1n2 - 7 * c2c2 - 6 * c1n * c2n + c2n2) * e2 +
                4 * L2 * ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2))) /
        (2. * L2);
    REAL8 eczp2 = (1. + e * cz) * (1. + e * cz);
    REAL8 cbL3_0, L3_0, L3_2, L3_3, L3_4;
    L3_0 = eczp2 / Omg;
    cbL3_0 = cbrt(L3_0);
    L3_2 = cbL3_0 * (9 - 4 * cz * e - e2 * (-3 + eta) + eta) / 2.;
    L3_3 = cbL3_0 * ((3 * (2 * c1l * dm * pe - 2 * c2l * dm * pe - (c1l + c2l) * (-2 + eta) * pe - 2 * c1e * dm * pl +
                           2 * c2e * dm * pl + (c1e + c2e) * (-2 + eta) * pl)) /
                     2.);
    L3_4 =
        (cbL3_0 *
             (36 * c1c1 * dm + 72 * c1c2 * dm - 72 * c1n2 * dm - 36 * c2c2 * dm + 72 * c2n2 * dm -
              9 * (15 + 8 * c1c1 + 8 * c2c2 - 8 * (c1n2 - 6 * c1n * c2n + c2n2)) * eta - 72 * c1n2 * dm * eta +
              72 * c2n2 * dm * eta + 5 * e4 * (9 + (-3 + eta) * eta) + (5 + 72 * c1nPc2nsq) * eta2 +
              2 * e2 *
                  (143 - 12 * c1n2 + 21 * c2c2 - 12 * c2n2 - 12 * c1n2 * dm - 21 * c2c2 * dm + 12 * c2n2 * dm +
                   21 * c1c1 * (1 + dm) - 21 * eta + 12 * (c1n2 - 6 * c2c2 - 6 * c1n * c2n + c2n2) * eta -
                   12 * c1n2 * dm * eta + 30 * c2c2 * dm * eta + 12 * c2n2 * dm * eta +
                   6 * c1c2 * (1 + dm) * (2 + 5 * eta) + 6 * c1c1 * eta * (-12 - 5 * dm + 5 * eta) +
                   (-5 + 30 * c2c2 + 12 * c1nPc2nsq) * eta2)) *
             Omg -
         8 * cz * e *
             (3 * c1c1 * cbL3_0 * dm * Omg - 3 * c2c2 * cbL3_0 * dm * Omg + 3 * cbL3_0 * (7 + c1c1 + c2c2 + e2) * Omg -
              cbL3_0 * eta * Omg - 12 * c1c1 * cbL3_0 * eta * Omg + 6 * c1c2 * cbL3_0 * eta * Omg -
              12 * c2c2 * cbL3_0 * eta * Omg - 6 * c1c1 * cbL3_0 * dm * eta * Omg + 6 * c1c2 * cbL3_0 * dm * eta * Omg +
              6 * c2c2 * cbL3_0 * dm * eta * Omg + cbL3_0 * e2 * eta * Omg + 6 * c1c1 * cbL3_0 * eta2 * Omg +
              6 * c2c2 * cbL3_0 * eta2 * Omg + 3 * c1e2 * (1 + dm + 2 * eta * (-2 - dm + eta)) * pe2 +
              3 * c2e2 * (1 - dm + 2 * eta * (-2 + dm + eta)) * pe2 +
              6 * c2e * (c2l - c2l * dm + 2 * c2l * eta * (-2 + dm + eta) + 2 * c1l * eta2) * pe * pl +
              6 * c1e * pe * (c1l * (1 + dm + 2 * eta * (-2 - dm + eta)) * pl + 2 * eta2 * (c2e * pe + c2l * pl)) +
              3 * (c1l2 + c2l2) * pl2 + 3 * c1l2 * dm * pl2 - 3 * c2l2 * dm * pl2 - 12 * (c1l2 + c2l2) * eta * pl2 -
              6 * c1l2 * dm * eta * pl2 + 6 * c2l2 * dm * eta * pl2 + 6 * pow(c1l + c2l, 2) * eta2 * pl2) +
         3 * (3 * (45 + 4 * c1c1 + 8 * c1c2 - 8 * c1n2 + 4 * c2c2 - 8 * c2n2) * cbL3_0 * Omg +
              2 * c2e2 * (-2 + 2 * dm + dm * e2 * (1 - 2 * eta) - 4 * eta * (-2 + dm + eta)) * pe2 +
              2 * c1e2 * (-2 * (1 + dm) + 4 * (2 + dm - eta) * eta + dm * e2 * (-1 + 2 * eta)) * pe2 -
              4 * c2e * (c2l * (2 - 2 * dm + 4 * eta * (-2 + dm + eta) + dm * e2 * (-1 + 2 * eta)) + 4 * c1l * eta2) *
                  pe * pl -
              4 * c1e * pe *
                  (c1l * (2 + 2 * dm + dm * e2 * (1 - 2 * eta) + 4 * eta * (-2 - dm + eta)) * pl +
                   4 * eta2 * (c2e * pe + c2l * pl)) +
              2 *
                  (c2l2 * (-2 + 2 * dm + dm * e2 * (1 - 2 * eta) - 4 * eta * (-2 + dm + eta)) +
                   c1l2 * (-2 * (1 + dm) + 4 * (2 + dm - eta) * eta + dm * e2 * (-1 + 2 * eta)) -
                   8 * c1l * c2l * eta2) *
                  pl2) -
         12 * (cz * cz) * e2 *
             (c1e2 * pe2 + c2e2 * pe2 + 2 * c1e * c1l * pe * pl + 2 * c2e * c2l * pe * pl +
              2 * eta2 * pow((c1e + c2e) * pe + (c1l + c2l) * pl, 2) + c1l2 * pl2 + c2l2 * pl2 -
              4 * eta * ((c1e2 + c2e2) * pe2 + 2 * (c1e * c1l + c2e * c2l) * pe * pl + (c1l2 + c2l2) * pl2)) +
         2 * cz2 * e2 *
             (-((16 + 3 * c1c1 + 3 * c2c2) * cbL3_0 * Omg) + 3 * c1e2 * dm * (-1 + 2 * eta) * pe2 +
              6 * c1e * c1l * dm * (-1 + 2 * eta) * pe * pl -
              3 * (c1c1 * cbL3_0 * dm * Omg - c2c2 * cbL3_0 * dm * Omg - 4 * c1c1 * cbL3_0 * eta * Omg +
                   2 * c1c2 * cbL3_0 * eta * Omg - 4 * c2c2 * cbL3_0 * eta * Omg - 2 * c1c1 * cbL3_0 * dm * eta * Omg +
                   2 * c1c2 * cbL3_0 * dm * eta * Omg + 2 * c2c2 * cbL3_0 * dm * eta * Omg +
                   2 * c1c1 * cbL3_0 * eta2 * Omg + 2 * c2c2 * cbL3_0 * eta2 * Omg + c2e2 * dm * (-1 + 2 * eta) * pe2 +
                   2 * c2e * c2l * dm * (-1 + 2 * eta) * pe * pl - c2l2 * dm * pl2 + c1l2 * dm * (1 - 2 * eta) * pl2 +
                   2 * c2l2 * dm * eta * pl2))) /
        (24. * cbL3_0 * cbL3_0 * Omg);
    *ret_prT = sz * (pr0 + pr2 + pr3 + pr4);
    *ret_prDot = eczp2 * (prDot0 + prDot2 + prDot3 + prDot4);
    *ret_rDot = sz * (rDot0 + rDot2 + rDot3 + rDot4);
    *ret_r = (r_0 + r_2 + r_3 + r_4) / (1. + e * cz);
    *ret_L = cbrt(L3_0 + L3_2 + L3_3 + L3_4);
    return;
}
...
INT CalculateAOmegaFromrpphi(REAL8 r, REAL8 pphi, SpinEOBParams *core, REAL8 *omegaOut)
{
    ...
    {
        // fprintf(out, "%.16e\t%.16e\t%.16e\n", i*dt,
        // gsl_spline_eval(spline_rDot, i*dt, acc_rDot),
        // gsl_spline_eval(spline_omega, i*dt, acc_omega)); if (i>1
        // && gsl_spline_eval(spline_rDot, i*dt, acc_rDot) *
        // gsl_spline_eval(spline_rDot, (i+1)*dt, acc_rDot) < 0)
        // {
        //     averaged_omega = (averaged_omega + gsl_spline_eval(spline_omega,
        //     i*dt, acc_omega)) / (i + 1); break;
                                    ...
                                    SpinEOBParams *seobParams)
{
    ...
    if (seobParams->alignedSpins)
    {
        ...
        // mSpin1data[1], mSpin1data[2]); print_debug("mSpin2data = (%g, %g,
        // %g)\n", mSpin2data[0], mSpin2data[1], mSpin2data[2]); if
        // (EOBInitialConditionsSA_egw(ICvalues, m1, m2, fMin, ecc, 0,
        // mSpin1data, mSpin2data, seobParams) != CEV_SUCCESS)
        //     return CEV_FAILURE;
        if (EOBInitialConditionsSA_e_anomaly(ICvalues, m1, m2, fMin, ecc, zeta, 0, mSpin1data, mSpin2data,
                                             seobParams) != CEV_SUCCESS)
            return CEV_FAILURE;
        // if (EOBInitialConditionsSA_e_anomaly_v240228(ICvalues, m1, m2, fMin,
        // ecc, zeta, 0, mSpin1data, mSpin2data, seobParams) != CEV_SUCCESS)
        //     return CEV_FAILURE;
    }
    else
    {
        ...
        if (EOBInitialConditionsPrec_e_anomaly(ICvalues, m1, m2, fMin, ecc, zeta, xi, 0, mSpin1data, mSpin2data,
                                               seobParams) != CEV_SUCCESS)
            return CEV_FAILURE;
        // if (EOBInitialConditionsPrec(ICvalues, m1, m2, fMin, ecc, 0,
        // mSpin1data, mSpin2data, seobParams) != CEV_SUCCESS)
        //     return CEV_FAILURE;
    }
    return CEV_SUCCESS;
...
INT SEOBInitialConditions_egw(REAL8Vector *ICvalues, REAL8 MfMin, REAL8 ecc, SpinEOBParams *seobParams)
{
    ...
    if (seobParams->alignedSpins)
    {
        ...
        // mSpin1data[1], mSpin1data[2]); print_debug("mSpin2data = (%g, %g,
        // %g)\n", mSpin2data[0], mSpin2data[1], mSpin2data[2]);
        if (EOBInitialConditionsSA_egw(ICvalues, m1, m2, fMin, ecc, 0, mSpin1data, mSpin2data, seobParams) !=
            CEV_SUCCESS)
            return CEV_FAILURE;
    }
    else
...
INT EvaluateOmega22SA_form_rpphi(REAL8 r, REAL8 pphi, SpinEOBParams *seobParams, REAL8 *omega22)
{
    ...
    integrator =
        XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_invConserve,
    ...
    integrator->stopontestonly = 1;
    integrator->retries = 1;
    retLenMinus = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, initvals, 0., 10., deltaT, deltaT_min,
                                                       &dynamics_Minus);
    if (retLenMinus < 0)
    {
        PRINT_LOG_INFO(LOG_CRITICAL, "Integration Failed!!!");
    ...
    // plus
    integrator =
        XLALAdaptiveRungeKutta4Init(nb_Hamiltonian_variables_spinsaligned, XLALSpinAlignedHcapDerivative_Conserve,
    ...
    integrator->stopontestonly = 1;
    integrator->retries = 1;
    retLenPlus = XLALAdaptiveRungeKutta4NoInterpolate(integrator, seobParams, initvals, 0., 10., deltaT, deltaT_min,
                                                      &dynamics_Plus);
    if (retLenPlus < 0)
    {
        PRINT_LOG_INFO(LOG_CRITICAL, "Integration Failed!!!");
    ...
    status = SEOBConvertSpinAlignedDynamicsToGenericSpins(&dynamics, dynamics_Plus, retLenPlus, seobParams->chi1,
                                                          seobParams->chi2, seobParams);
    if (status != CEV_SUCCESS)
    {
        PRINT_LOG_INFO(LOG_CRITICAL, "Failure in dynamics transformation.");
    ...
    for (i = 0; i < retLenPlus; i++)
    {
        print_out("%.16e\t%.16e\t%.16e\n", seobdynamicsAdaS->tVec[i], seobdynamicsAdaS->omegaVec[i], h22Phase->data[i]);
        // h22Omega->data[i] = gsl_spline_eval_deriv(spline,
        // seobdynamicsAdaS->tVec[i], acc);
    }
                                            ...
                                            REAL8 *ret_e0)
{
    ...
    dHdx = XLALSpinPrecHcapNumDerivWRTParam(0, values, params);
    dHdpy = XLALSpinPrecHcapNumDerivWRTParam(4, values, params);
    dHdpz = XLALSpinPrecHcapNumDerivWRTParam(5, values, params);
