...
static INT debug_InitialCondition_egw(REAL8 m1, REAL8 m2, REAL8 s1x, REAL8 s1y, REAL8 s1z, REAL8 s2x, REAL8 s2y,
                                      REAL8 s2z, REAL8 phi0, REAL8 distance, REAL8 ecc, REAL8 f_min, REAL8 INdeltaT,
...
static INT debug_InitialCondition_anomaly(REAL8 m1, REAL8 m2, REAL8 s1x, REAL8 s1y, REAL8 s1z, REAL8 s2x, REAL8 s2y,
                                          REAL8 s2z, REAL8 phi0, REAL8 distance, REAL8 ecc, REAL8 zeta, REAL8 xi,
                                          REAL8 f_min, REAL8 INdeltaT, REAL8 inc, HyperParams *hparams)
{
                 ...
                 REAL8 inc, HyperParams *hparams)
{
    ...
    {
    case 2:
        debug_InitialCondition_anomaly(m1, m2, s1x, s1y, s1z, s2x, s2y, s2z, phi0, distance, ecc, zeta, xi, f_min,
                                       INdeltaT, inc, hparams);
        break;
    case 1:
    default:
        debug_InitialCondition_egw(m1, m2, s1x, s1y, s1z, s2x, s2y, s2z, phi0, distance, ecc, f_min, INdeltaT, inc,
                                   hparams);
        break;
    }
    return CEV_SUCCESS;
