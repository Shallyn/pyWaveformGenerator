...
#include "pUtils.h"
REAL8 EOBHamiltonian(const REAL8 eta, REAL8Vector *x, REAL8Vector *p, REAL8Vector *s1Vec, REAL8Vector *s2Vec,
...
REAL8 XLALSpinHcapNumDerivWRTParam(const INT paramIdx,       /**<< Index of the parameters */
...
REAL8 XLALSimIMRSpinPrecEOBHamiltonian(const REAL8 eta,        /**<< Symmetric mass ratio */
...
REAL8 XLALSimIMRSpinPrecEOBCalcOmega(const REAL8 values[],     /**<< Dynamical variables */
                                     SpinEOBParams *funcParams /**<< EOB parameters */
);
...
REAL8 XLALCalculateSphHamiltonianDeriv2(const int idx1,       /**<< Derivative w.r.t. index 1 */
