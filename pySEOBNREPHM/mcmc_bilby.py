...
def run_bilby_mcmc(argv):
    ...
    prior['phi_12'] =  bilby.core.prior.Uniform(name='phi_12', minimum=0.0,maximum=2.*np.pi, boundary = "periodic")
    prior['phi_jl'] =  bilby.core.prior.Uniform(name='phi_jl', minimum=0.0,maximum=2.*np.pi, boundary = "periodic")

    prior['luminosity_distance'] = bilby.core.prior.Uniform(name="luminosity_distance", minimum=10., maximum=2000.)

    prior['theta_jn'] = bilby.core.prior.Uniform(name="theta_jn", minimum=0., maximum=np.pi)
    ...
    prior['geocent_time'] = bilby.core.prior.Uniform(name="geocent_time", minimum=gps0-1.0, 
                                                    maximum=gps0+1.0)
    prior['ra'] = bilby.core.prior.Uniform(name="phase", minimum=0, maximum=2*np.pi, boundary = "periodic")
    prior['dec'] = bilby.core.prior.Uniform(name="dec", minimum=-np.pi/2., maximum=np.pi/2.)
