...
def calculate_strain(params, f_min, gps0 = 1356566418, detectors = None, is_only22 = False, log_level = 1, code_version = 2, ret_dyn = False, **kwargs) -> rTimeSeries:
...
def calculate_waveform_ep(params, f_min, srate = 16384, is_coframe = False, code_version=1, **kwargs):
    '''
